...
extension Array where Element == SecurityTokenModel.TagKeyType {
    public func validateAsTagKeyListType() throws {
        ...
        if self.count > 50 {
            throw SecurityTokenError.validationError(reason: "The provided value to tagKeyListType violated the maximum length constraint.")
        }
    }
}
...
extension SecurityTokenModel.TagKeyType {
    public func validateAsTagKeyType() throws {
        if self.count < 1 {
            throw SecurityTokenError.validationError(reason: "The provided value to tagKeyType violated the minimum length constraint.")
        }

        if self.count > 128 {
            throw SecurityTokenError.validationError(reason: "The provided value to tagKeyType violated the maximum length constraint.")
        }
...
extension Array where Element == SecurityTokenModel.Tag {
    public func validateAsTagListType() throws {
        ...
        if self.count > 50 {
            throw SecurityTokenError.validationError(reason: "The provided value to tagListType violated the maximum length constraint.")
        }
    }
}
...
extension SecurityTokenModel.TagValueType {
    public func validateAsTagValueType() throws {
        if self.count < 0 {
            throw SecurityTokenError.validationError(reason: "The provided value to tagValueType violated the minimum length constraint.")
        }

        if self.count > 256 {
            throw SecurityTokenError.validationError(reason: "The provided value to tagValueType violated the maximum length constraint.")
        }
