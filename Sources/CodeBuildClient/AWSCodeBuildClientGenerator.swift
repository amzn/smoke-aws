...
//
// AWSCodeBuildClientGenerator.swift
// CodeBuildClient
//
...
/**
 AWS Client Generator for the CodeBuild service.
 */
public struct AWSCodeBuildClientGenerator {
    ...
    public func with<NewInvocationReportingType: HTTPClientCoreInvocationReporting>(
            reporting: NewInvocationReportingType) -> AWSCodeBuildClient<NewInvocationReportingType> {
        return AWSCodeBuildClient<NewInvocationReportingType>(
    ...
    public func with<NewTraceContextType: InvocationTraceContext>(
            ...
            traceContext: NewTraceContextType) -> AWSCodeBuildClient<StandardHTTPClientCoreInvocationReporting<NewTraceContextType>> {
    ...
    public func with(
            logger: Logging.Logger,
            internalRequestId: String = "none") -> AWSCodeBuildClient<StandardHTTPClientCoreInvocationReporting<AWSClientInvocationTraceContext>> {
        let reporting = StandardHTTPClientCoreInvocationReporting(
            logger: logger,
            internalRequestId: internalRequestId,
