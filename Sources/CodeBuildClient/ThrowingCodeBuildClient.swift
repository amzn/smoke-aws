...
/**
 Mock Client for the CodeBuild service that by default always throws from its methods.
 */
public struct ThrowingCodeBuildClient: CodeBuildClientProtocol {
    let error: CodeBuildError
     ...
     */
    public init(error: CodeBuildError,
