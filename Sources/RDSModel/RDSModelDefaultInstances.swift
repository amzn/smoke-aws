...
public extension CreateDBClusterMessage {
    ...
    static let __default: RDSModel.CreateDBClusterMessage = {
        let defaultInstance = RDSModel.CreateDBClusterMessage(
            ...
            enableLocalWriteForwarding: nil,
...
public extension DBCluster {
    ...
    static let __default: RDSModel.DBCluster = {
        let defaultInstance = RDSModel.DBCluster(
            ...
            localWriteForwardingStatus: nil,
...
public extension DBEngineVersion {
    ...
    static let __default: RDSModel.DBEngineVersion = {
        let defaultInstance = RDSModel.DBEngineVersion(
            ...
            supportsLocalWriteForwarding: nil,
...
public extension DBSnapshot {
    ...
    static let __default: RDSModel.DBSnapshot = {
        let defaultInstance = RDSModel.DBSnapshot(
            ...
            masterUsername: nil,
            optionGroupName: nil,
            originalSnapshotCreateTime: nil,
            percentProgress: nil,
            port: nil,
            processorFeatures: nil,
            snapshotCreateTime: nil,
...
public extension NetworkTypeNotSupported {
    /**
     Default instance of the NetworkTypeNotSupported structure.
     */
    static let __default: RDSModel.NetworkTypeNotSupported = {
        let defaultInstance = RDSModel.NetworkTypeNotSupported()
...
public extension ServerlessV2ScalingConfiguration {
    /**
     Default instance of the ServerlessV2ScalingConfiguration structure.
     */
    static let __default: RDSModel.ServerlessV2ScalingConfiguration = {
        let defaultInstance = RDSModel.ServerlessV2ScalingConfiguration(
            maxCapacity: nil,
            minCapacity: nil)
...
public extension ServerlessV2ScalingConfigurationInfo {
    /**
     Default instance of the ServerlessV2ScalingConfigurationInfo structure.
     */
    static let __default: RDSModel.ServerlessV2ScalingConfigurationInfo = {
        let defaultInstance = RDSModel.ServerlessV2ScalingConfigurationInfo(
            maxCapacity: nil,
            minCapacity: nil)
