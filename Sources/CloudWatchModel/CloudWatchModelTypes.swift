...
extension CloudWatchModel.AlarmRule {
    public func validateAsAlarmRule() throws {
        if self.count < 1 {
            throw CloudWatchCodingError.validationError(reason: "The provided value to AlarmRule violated the minimum length constraint.")
        }

        if self.count > 10240 {
            throw CloudWatchCodingError.validationError(reason: "The provided value to AlarmRule violated the maximum length constraint.")
        }
    }
}
...
extension CloudWatchModel.AnomalyDetectorMetricTimezone {
    public func validateAsAnomalyDetectorMetricTimezone() throws {
        ...
        if self.count > 50 {
            throw CloudWatchCodingError.validationError(reason: "The provided value to AnomalyDetectorMetricTimezone violated the maximum length constraint.")
        }
...
extension CloudWatchModel.InsightRuleDefinition {
    public func validateAsInsightRuleDefinition() throws {
        if self.count < 1 {
            throw CloudWatchCodingError.validationError(reason: "The provided value to InsightRuleDefinition violated the minimum length constraint.")
        }

        if self.count > 8192 {
            throw CloudWatchCodingError.validationError(reason: "The provided value to InsightRuleDefinition violated the maximum length constraint.")
        }
...
extension CloudWatchModel.InsightRuleMaxResults {
    public func validateAsInsightRuleMaxResults() throws {
        if self < 1 {
            throw CloudWatchCodingError.validationError(reason: "The provided value to InsightRuleMaxResults violated the minimum range constraint.")
        }

        if self > 500 {
            throw CloudWatchCodingError.validationError(reason: "The provided value to InsightRuleMaxResults violated the maximum range constraint.")
        }
    }
}
...
extension CloudWatchModel.InsightRuleMetricName {
    public func validateAsInsightRuleMetricName() throws {
        if self.count < 1 {
            throw CloudWatchCodingError.validationError(reason: "The provided value to InsightRuleMetricName violated the minimum length constraint.")
        }

        if self.count > 32 {
            throw CloudWatchCodingError.validationError(reason: "The provided value to InsightRuleMetricName violated the maximum length constraint.")
        }
...
extension CloudWatchModel.InsightRuleName {
    public func validateAsInsightRuleName() throws {
        if self.count < 1 {
            throw CloudWatchCodingError.validationError(reason: "The provided value to InsightRuleName violated the minimum length constraint.")
        }

        if self.count > 128 {
            throw CloudWatchCodingError.validationError(reason: "The provided value to InsightRuleName violated the maximum length constraint.")
        }
...
extension CloudWatchModel.InsightRuleOrderBy {
    public func validateAsInsightRuleOrderBy() throws {
        if self.count < 1 {
            throw CloudWatchCodingError.validationError(reason: "The provided value to InsightRuleOrderBy violated the minimum length constraint.")
        }

        if self.count > 32 {
            throw CloudWatchCodingError.validationError(reason: "The provided value to InsightRuleOrderBy violated the maximum length constraint.")
        }
...
extension CloudWatchModel.InsightRuleState {
    public func validateAsInsightRuleState() throws {
        if self.count < 1 {
            throw CloudWatchCodingError.validationError(reason: "The provided value to InsightRuleState violated the minimum length constraint.")
        }

        if self.count > 32 {
            throw CloudWatchCodingError.validationError(reason: "The provided value to InsightRuleState violated the maximum length constraint.")
        }
