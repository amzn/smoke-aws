...
//
// ThrowingEventBridgeSchedulerClientV2.swift
...
/**
 Mock Client for the EventBridgeScheduler service that by default always throws from its methods.
 */
public struct ThrowingEventBridgeSchedulerClientV2: EventBridgeSchedulerClientProtocolV2 {
#if (os(Linux) && compiler(>=5.5)) || (!os(Linux) && compiler(>=5.5.2)) && canImport(_Concurrency)
    let error: EventBridgeSchedulerError
     ...
     */
    public init(error: EventBridgeSchedulerError,
