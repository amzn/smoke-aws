...
/**
 Mock Client for the Scheduler service by default returns the `__default` property of its return type.
 */
public struct MockSchedulerClientV2: SchedulerClientProtocolV2 {
