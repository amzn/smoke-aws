...
/**
 Invocations reporting for the SchedulerModel.
 */
public struct SchedulerInvocationsReporting<InvocationReportingType: HTTPClientCoreInvocationReporting> {
    ...
    public init(reporting: InvocationReportingType, operationsReporting: SchedulerOperationsReporting) {
