 ...
 */
public struct AWSCloudformationClientGenerator {
    ...
    public func with<NewInvocationReportingType: HTTPClientCoreInvocationReporting>(
            reporting: NewInvocationReportingType) -> AWSCloudformationClient<NewInvocationReportingType> {
        return AWSCloudformationClient<NewInvocationReportingType>(
    ...
    public func with(
            logger: Logging.Logger,
            internalRequestId: String = "none") -> AWSCloudformationClient<StandardHTTPClientCoreInvocationReporting<AWSClientInvocationTraceContext>> {
        let reporting = StandardHTTPClientCoreInvocationReporting(
            logger: logger,
            internalRequestId: internalRequestId,
