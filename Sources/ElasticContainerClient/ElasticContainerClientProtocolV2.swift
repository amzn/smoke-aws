...
public protocol ElasticContainerClientProtocolV2 {
    ...
    typealias GetTaskProtectionFunctionType = (
            _ input: ElasticContainerModel.GetTaskProtectionRequest) async throws -> ElasticContainerModel.GetTaskProtectionResponse
    ...
    typealias ListServicesByNamespaceFunctionType = (
            _ input: ElasticContainerModel.ListServicesByNamespaceRequest) async throws -> ElasticContainerModel.ListServicesByNamespaceResponse
    ...
    typealias UpdateTaskProtectionFunctionType = (
            _ input: ElasticContainerModel.UpdateTaskProtectionRequest) async throws -> ElasticContainerModel.UpdateTaskProtectionResponse
