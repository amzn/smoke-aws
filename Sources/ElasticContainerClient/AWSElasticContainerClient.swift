...
public struct AWSElasticContainerClient<InvocationReportingType: HTTPClientCoreInvocationReporting>: ElasticContainerClientProtocol {
    ...
    public func getTaskProtectionAsync(
        ...
        let handlerDelegate = AWSClientInvocationDelegate(
                    ...
                    awsRegion: awsRegion,
                    service: service,
                    operation: ElasticContainerModelOperations.getTaskProtection.rawValue,
                    target: target)

        let invocationContext = HTTPClientInvocationContext(reporting: self.invocationsReporting.getTaskProtection,
                                                            handlerDelegate: handlerDelegate)
        let requestInput = GetTaskProtectionOperationHTTPRequestInput(encodable: input)
    ...
    public func listServicesByNamespaceAsync(
        ...
        let handlerDelegate = AWSClientInvocationDelegate(
                    ...
                    awsRegion: awsRegion,
                    service: service,
                    operation: ElasticContainerModelOperations.listServicesByNamespace.rawValue,
                    target: target)

        let invocationContext = HTTPClientInvocationContext(reporting: self.invocationsReporting.listServicesByNamespace,
                                                            handlerDelegate: handlerDelegate)
        let requestInput = ListServicesByNamespaceOperationHTTPRequestInput(encodable: input)
    ...
    public func updateTaskProtectionAsync(
        ...
        let handlerDelegate = AWSClientInvocationDelegate(
                    ...
                    awsRegion: awsRegion,
                    service: service,
                    operation: ElasticContainerModelOperations.updateTaskProtection.rawValue,
                    target: target)

        let invocationContext = HTTPClientInvocationContext(reporting: self.invocationsReporting.updateTaskProtection,
                                                            handlerDelegate: handlerDelegate)
        let requestInput = UpdateTaskProtectionOperationHTTPRequestInput(encodable: input)
