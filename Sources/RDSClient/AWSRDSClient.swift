...
public struct AWSRDSClient<InvocationReportingType: HTTPClientCoreInvocationReporting>: RDSClientProtocol {
    ...
    public func createBlueGreenDeploymentAsync(
        ...
        let invocationContext = HTTPClientInvocationContext(reporting: self.invocationsReporting.createBlueGreenDeployment,
                                                            handlerDelegate: handlerDelegate)
        let wrappedInput = CreateBlueGreenDeploymentOperationHTTPRequestInput(encodable: input)
        
        let requestInput = QueryWrapperHTTPRequestInput(
            wrappedInput: wrappedInput,
            action: RDSModelOperations.createBlueGreenDeployment.rawValue,
            version: apiVersion)
    ...
    public func deleteBlueGreenDeploymentAsync(
        ...
        let invocationContext = HTTPClientInvocationContext(reporting: self.invocationsReporting.deleteBlueGreenDeployment,
                                                            handlerDelegate: handlerDelegate)
        let wrappedInput = DeleteBlueGreenDeploymentOperationHTTPRequestInput(encodable: input)
        
        let requestInput = QueryWrapperHTTPRequestInput(
            wrappedInput: wrappedInput,
            action: RDSModelOperations.deleteBlueGreenDeployment.rawValue,
            version: apiVersion)
    ...
    public func describeBlueGreenDeploymentsAsync(
        ...
        let invocationContext = HTTPClientInvocationContext(reporting: self.invocationsReporting.describeBlueGreenDeployments,
                                                            handlerDelegate: handlerDelegate)
        let wrappedInput = DescribeBlueGreenDeploymentsOperationHTTPRequestInput(encodable: input)
        
        let requestInput = QueryWrapperHTTPRequestInput(
            wrappedInput: wrappedInput,
            action: RDSModelOperations.describeBlueGreenDeployments.rawValue,
            version: apiVersion)
    ...
    public func switchoverBlueGreenDeploymentAsync(
        ...
        let invocationContext = HTTPClientInvocationContext(reporting: self.invocationsReporting.switchoverBlueGreenDeployment,
                                                            handlerDelegate: handlerDelegate)
        let wrappedInput = SwitchoverBlueGreenDeploymentOperationHTTPRequestInput(encodable: input)
