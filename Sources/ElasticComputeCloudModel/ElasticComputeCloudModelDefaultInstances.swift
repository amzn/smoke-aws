...
public extension AcceptTransitGatewayMulticastDomainAssociationsRequest {
    /**
     Default instance of the AcceptTransitGatewayMulticastDomainAssociationsRequest structure.
     */
    static let __default: ElasticComputeCloudModel.AcceptTransitGatewayMulticastDomainAssociationsRequest = {
        let defaultInstance = ElasticComputeCloudModel.AcceptTransitGatewayMulticastDomainAssociationsRequest(
            dryRun: nil,
            subnetIds: nil,
...
public extension AcceptTransitGatewayMulticastDomainAssociationsResult {
    /**
     Default instance of the AcceptTransitGatewayMulticastDomainAssociationsResult structure.
     */
    static let __default: ElasticComputeCloudModel.AcceptTransitGatewayMulticastDomainAssociationsResult = {
        let defaultInstance = ElasticComputeCloudModel.AcceptTransitGatewayMulticastDomainAssociationsResult(
            associations: nil)
...
public extension AccessScopeAnalysisFinding {
    /**
     Default instance of the AccessScopeAnalysisFinding structure.
     */
    static let __default: ElasticComputeCloudModel.AccessScopeAnalysisFinding = {
        let defaultInstance = ElasticComputeCloudModel.AccessScopeAnalysisFinding(
            findingComponents: nil,
            findingId: nil,
            networkInsightsAccessScopeAnalysisId: nil,
            networkInsightsAccessScopeId: nil)

        return defaultInstance
    }()
}

public extension AccessScopePath {
    /**
     Default instance of the AccessScopePath structure.
     */
    static let __default: ElasticComputeCloudModel.AccessScopePath = {
        let defaultInstance = ElasticComputeCloudModel.AccessScopePath(
            destination: nil,
            source: nil,
...
public extension AccessScopePathRequest {
    /**
     Default instance of the AccessScopePathRequest structure.
     */
    static let __default: ElasticComputeCloudModel.AccessScopePathRequest = {
        let defaultInstance = ElasticComputeCloudModel.AccessScopePathRequest(
            destination: nil,
            source: nil,
            throughResources: nil)
...
public extension AddIpamOperatingRegion {
    /**
     Default instance of the AddIpamOperatingRegion structure.
     */
    static let __default: ElasticComputeCloudModel.AddIpamOperatingRegion = {
        let defaultInstance = ElasticComputeCloudModel.AddIpamOperatingRegion(
            regionName: nil)
...
public extension AddedPrincipal {
    /**
     Default instance of the AddedPrincipal structure.
     */
    static let __default: ElasticComputeCloudModel.AddedPrincipal = {
        let defaultInstance = ElasticComputeCloudModel.AddedPrincipal(
            principal: nil,
            principalType: nil,
            serviceId: nil,
            servicePermissionId: nil)

        return defaultInstance
    }()
}

public extension AdditionalDetail {
    /**
     Default instance of the AdditionalDetail structure.
     */
    static let __default: ElasticComputeCloudModel.AdditionalDetail = {
        let defaultInstance = ElasticComputeCloudModel.AdditionalDetail(
            additionalDetailType: nil,
            component: nil,
            loadBalancers: nil,
            ruleGroupRuleOptionsPairs: nil,
            ruleGroupTypePairs: nil,
            ruleOptions: nil,
            serviceName: nil,
            vpcEndpointService: nil)
...
public extension AllocateIpamPoolCidrRequest {
    /**
     Default instance of the AllocateIpamPoolCidrRequest structure.
     */
    static let __default: ElasticComputeCloudModel.AllocateIpamPoolCidrRequest = {
        let defaultInstance = ElasticComputeCloudModel.AllocateIpamPoolCidrRequest(
            cidr: nil,
            clientToken: nil,
            description: nil,
            disallowedCidrs: nil,
...
public extension AllocateIpamPoolCidrResult {
    /**
     Default instance of the AllocateIpamPoolCidrResult structure.
     */
    static let __default: ElasticComputeCloudModel.AllocateIpamPoolCidrResult = {
        let defaultInstance = ElasticComputeCloudModel.AllocateIpamPoolCidrResult(
            ipamPoolAllocation: nil)
...
public extension AlternatePathHint {
    /**
     Default instance of the AlternatePathHint structure.
     */
    static let __default: ElasticComputeCloudModel.AlternatePathHint = {
        let defaultInstance = ElasticComputeCloudModel.AlternatePathHint(
            componentArn: nil,
            componentId: nil)
...
public extension AnalysisAclRule {
    /**
     Default instance of the AnalysisAclRule structure.
     */
    static let __default: ElasticComputeCloudModel.AnalysisAclRule = {
        let defaultInstance = ElasticComputeCloudModel.AnalysisAclRule(
            cidr: nil,
            egress: nil,
            portRange: nil,
            protocol: nil,
...
public extension AnalysisComponent {
    /**
     Default instance of the AnalysisComponent structure.
     */
    static let __default: ElasticComputeCloudModel.AnalysisComponent = {
        let defaultInstance = ElasticComputeCloudModel.AnalysisComponent(
            arn: nil,
            id: nil,
            name: nil)
...
public extension AnalysisLoadBalancerListener {
    /**
     Default instance of the AnalysisLoadBalancerListener structure.
     */
    static let __default: ElasticComputeCloudModel.AnalysisLoadBalancerListener = {
        let defaultInstance = ElasticComputeCloudModel.AnalysisLoadBalancerListener(
            instancePort: nil,
...
public extension AnalysisLoadBalancerTarget {
    /**
     Default instance of the AnalysisLoadBalancerTarget structure.
     */
    static let __default: ElasticComputeCloudModel.AnalysisLoadBalancerTarget = {
        let defaultInstance = ElasticComputeCloudModel.AnalysisLoadBalancerTarget(
            address: nil,
...
public extension AnalysisPacketHeader {
    /**
     Default instance of the AnalysisPacketHeader structure.
     */
    static let __default: ElasticComputeCloudModel.AnalysisPacketHeader = {
        let defaultInstance = ElasticComputeCloudModel.AnalysisPacketHeader(
...
public extension AnalysisRouteTableRoute {
    /**
     Default instance of the AnalysisRouteTableRoute structure.
     */
    static let __default: ElasticComputeCloudModel.AnalysisRouteTableRoute = {
        let defaultInstance = ElasticComputeCloudModel.AnalysisRouteTableRoute(
...
public extension AnalysisSecurityGroupRule {
    /**
     Default instance of the AnalysisSecurityGroupRule structure.
     */
    static let __default: ElasticComputeCloudModel.AnalysisSecurityGroupRule = {
        let defaultInstance = ElasticComputeCloudModel.AnalysisSecurityGroupRule(
            cidr: nil,
            direction: nil,
            portRange: nil,
            prefixListId: nil,
...
public extension AssignPrivateNatGatewayAddressRequest {
    /**
     Default instance of the AssignPrivateNatGatewayAddressRequest structure.
     */
    static let __default: ElasticComputeCloudModel.AssignPrivateNatGatewayAddressRequest = {
        let defaultInstance = ElasticComputeCloudModel.AssignPrivateNatGatewayAddressRequest(
            dryRun: nil,
            natGatewayId: "value",
            privateIpAddressCount: nil,
            privateIpAddresses: nil)
...
public extension AssignPrivateNatGatewayAddressResult {
    /**
     Default instance of the AssignPrivateNatGatewayAddressResult structure.
     */
    static let __default: ElasticComputeCloudModel.AssignPrivateNatGatewayAddressResult = {
        let defaultInstance = ElasticComputeCloudModel.AssignPrivateNatGatewayAddressResult(
...
public extension AssociateEnclaveCertificateIamRoleRequest {
    /**
     Default instance of the AssociateEnclaveCertificateIamRoleRequest structure.
     */
    static let __default: ElasticComputeCloudModel.AssociateEnclaveCertificateIamRoleRequest = {
        let defaultInstance = ElasticComputeCloudModel.AssociateEnclaveCertificateIamRoleRequest(
...
public extension AssociateEnclaveCertificateIamRoleResult {
    /**
     Default instance of the AssociateEnclaveCertificateIamRoleResult structure.
     */
    static let __default: ElasticComputeCloudModel.AssociateEnclaveCertificateIamRoleResult = {
        let defaultInstance = ElasticComputeCloudModel.AssociateEnclaveCertificateIamRoleResult(
            certificateS3BucketName: nil,
            certificateS3ObjectKey: nil,
            encryptionKmsKeyId: nil)
...
public extension AssociateInstanceEventWindowRequest {
    /**
     Default instance of the AssociateInstanceEventWindowRequest structure.
     */
    static let __default: ElasticComputeCloudModel.AssociateInstanceEventWindowRequest = {
        let defaultInstance = ElasticComputeCloudModel.AssociateInstanceEventWindowRequest(
            associationTarget: InstanceEventWindowAssociationRequest.__default,
            dryRun: nil,
            instanceEventWindowId: "value")

        return defaultInstance
    }()
}

public extension AssociateInstanceEventWindowResult {
    /**
     Default instance of the AssociateInstanceEventWindowResult structure.
     */
    static let __default: ElasticComputeCloudModel.AssociateInstanceEventWindowResult = {
        let defaultInstance = ElasticComputeCloudModel.AssociateInstanceEventWindowResult(
            instanceEventWindow: nil)

        return defaultInstance
    }()
}

public extension AssociateIpamResourceDiscoveryRequest {
    /**
     Default instance of the AssociateIpamResourceDiscoveryRequest structure.
     */
    static let __default: ElasticComputeCloudModel.AssociateIpamResourceDiscoveryRequest = {
        let defaultInstance = ElasticComputeCloudModel.AssociateIpamResourceDiscoveryRequest(
            clientToken: nil,
            dryRun: nil,
            ipamId: "value",
            ipamResourceDiscoveryId: "value",
            tagSpecifications: nil)
...
public extension AssociateIpamResourceDiscoveryResult {
    /**
     Default instance of the AssociateIpamResourceDiscoveryResult structure.
     */
    static let __default: ElasticComputeCloudModel.AssociateIpamResourceDiscoveryResult = {
        let defaultInstance = ElasticComputeCloudModel.AssociateIpamResourceDiscoveryResult(
            ipamResourceDiscoveryAssociation: nil)

        return defaultInstance
    }()
}

public extension AssociateNatGatewayAddressRequest {
    /**
     Default instance of the AssociateNatGatewayAddressRequest structure.
     */
    static let __default: ElasticComputeCloudModel.AssociateNatGatewayAddressRequest = {
...
public extension AssociateNatGatewayAddressResult {
    /**
     Default instance of the AssociateNatGatewayAddressResult structure.
     */
    static let __default: ElasticComputeCloudModel.AssociateNatGatewayAddressResult = {
        let defaultInstance = ElasticComputeCloudModel.AssociateNatGatewayAddressResult(
            natGatewayAddresses: nil,
            natGatewayId: nil)
...
public extension AssociateTransitGatewayPolicyTableRequest {
    /**
     Default instance of the AssociateTransitGatewayPolicyTableRequest structure.
     */
    static let __default: ElasticComputeCloudModel.AssociateTransitGatewayPolicyTableRequest = {
        let defaultInstance = ElasticComputeCloudModel.AssociateTransitGatewayPolicyTableRequest(
            dryRun: nil,
            transitGatewayAttachmentId: "value",
            transitGatewayPolicyTableId: "value")

        return defaultInstance
    }()
}

public extension AssociateTransitGatewayPolicyTableResult {
    /**
     Default instance of the AssociateTransitGatewayPolicyTableResult structure.
     */
    static let __default: ElasticComputeCloudModel.AssociateTransitGatewayPolicyTableResult = {
        let defaultInstance = ElasticComputeCloudModel.AssociateTransitGatewayPolicyTableResult(
            association: nil)
...
public extension AssociatedRole {
    /**
     Default instance of the AssociatedRole structure.
     */
    static let __default: ElasticComputeCloudModel.AssociatedRole = {
        let defaultInstance = ElasticComputeCloudModel.AssociatedRole(
            associatedRoleArn: nil,
            certificateS3BucketName: nil,
            certificateS3ObjectKey: nil,
            encryptionKmsKeyId: nil)
...
public extension AuthorizeSecurityGroupEgressResult {
    /**
     Default instance of the AuthorizeSecurityGroupEgressResult structure.
     */
    static let __default: ElasticComputeCloudModel.AuthorizeSecurityGroupEgressResult = {
        let defaultInstance = ElasticComputeCloudModel.AuthorizeSecurityGroupEgressResult(
            return: nil,
...
public extension AuthorizeSecurityGroupIngressResult {
    /**
     Default instance of the AuthorizeSecurityGroupIngressResult structure.
     */
    static let __default: ElasticComputeCloudModel.AuthorizeSecurityGroupIngressResult = {
        let defaultInstance = ElasticComputeCloudModel.AuthorizeSecurityGroupIngressResult(
            return: nil,
            securityGroupRules: nil)
...
public extension CapacityAllocation {
    /**
     Default instance of the CapacityAllocation structure.
     */
    static let __default: ElasticComputeCloudModel.CapacityAllocation = {
        let defaultInstance = ElasticComputeCloudModel.CapacityAllocation(
            allocationType: nil,
            count: nil)
...
public extension ClientConnectOptions {
    /**
     Default instance of the ClientConnectOptions structure.
     */
    static let __default: ElasticComputeCloudModel.ClientConnectOptions = {
        let defaultInstance = ElasticComputeCloudModel.ClientConnectOptions(
            enabled: nil,
            lambdaFunctionArn: nil)

        return defaultInstance
    }()
}

public extension ClientConnectResponseOptions {
    /**
     Default instance of the ClientConnectResponseOptions structure.
     */
    static let __default: ElasticComputeCloudModel.ClientConnectResponseOptions = {
        let defaultInstance = ElasticComputeCloudModel.ClientConnectResponseOptions(
            enabled: nil,
            lambdaFunctionArn: nil,
            status: nil)
...
public extension ClientLoginBannerOptions {
    /**
     Default instance of the ClientLoginBannerOptions structure.
     */
    static let __default: ElasticComputeCloudModel.ClientLoginBannerOptions = {
        let defaultInstance = ElasticComputeCloudModel.ClientLoginBannerOptions(
            bannerText: nil,
            enabled: nil)
...
public extension ClientLoginBannerResponseOptions {
    /**
     Default instance of the ClientLoginBannerResponseOptions structure.
     */
    static let __default: ElasticComputeCloudModel.ClientLoginBannerResponseOptions = {
        let defaultInstance = ElasticComputeCloudModel.ClientLoginBannerResponseOptions(
            bannerText: nil,
            enabled: nil)
...
public extension ClientVpnEndpoint {
    ...
    static let __default: ElasticComputeCloudModel.ClientVpnEndpoint = {
        let defaultInstance = ElasticComputeCloudModel.ClientVpnEndpoint(
            ...
            clientCidrBlock: nil,
            clientConnectOptions: nil,
            clientLoginBannerOptions: nil,
            clientVpnEndpointId: nil,
...
public extension ClientVpnEndpointAttributeStatus {
    /**
     Default instance of the ClientVpnEndpointAttributeStatus structure.
     */
    static let __default: ElasticComputeCloudModel.ClientVpnEndpointAttributeStatus = {
        let defaultInstance = ElasticComputeCloudModel.ClientVpnEndpointAttributeStatus(
            code: nil,
            message: nil)
...
public extension CloudWatchLogOptions {
    /**
     Default instance of the CloudWatchLogOptions structure.
     */
    static let __default: ElasticComputeCloudModel.CloudWatchLogOptions = {
        let defaultInstance = ElasticComputeCloudModel.CloudWatchLogOptions(
            logEnabled: nil,
            logGroupArn: nil,
            logOutputFormat: nil)
...
public extension CloudWatchLogOptionsSpecification {
    /**
     Default instance of the CloudWatchLogOptionsSpecification structure.
     */
    static let __default: ElasticComputeCloudModel.CloudWatchLogOptionsSpecification = {
        let defaultInstance = ElasticComputeCloudModel.CloudWatchLogOptionsSpecification(
            logEnabled: nil,
            logGroupArn: nil,
            logOutputFormat: nil)
...
public extension CoipCidr {
    /**
     Default instance of the CoipCidr structure.
     */
    static let __default: ElasticComputeCloudModel.CoipCidr = {
        let defaultInstance = ElasticComputeCloudModel.CoipCidr(
            cidr: nil,
            coipPoolId: nil,
...
public extension CreateCoipCidrRequest {
    /**
     Default instance of the CreateCoipCidrRequest structure.
     */
    static let __default: ElasticComputeCloudModel.CreateCoipCidrRequest = {
        let defaultInstance = ElasticComputeCloudModel.CreateCoipCidrRequest(
            cidr: "value",
            coipPoolId: "value",
            dryRun: nil)
...
public extension CreateCoipCidrResult {
    /**
     Default instance of the CreateCoipCidrResult structure.
     */
    static let __default: ElasticComputeCloudModel.CreateCoipCidrResult = {
        let defaultInstance = ElasticComputeCloudModel.CreateCoipCidrResult(
            coipCidr: nil)
...
public extension CreateCoipPoolRequest {
    /**
     Default instance of the CreateCoipPoolRequest structure.
     */
    static let __default: ElasticComputeCloudModel.CreateCoipPoolRequest = {
        let defaultInstance = ElasticComputeCloudModel.CreateCoipPoolRequest(
            dryRun: nil,
...
public extension CreateCoipPoolResult {
    /**
     Default instance of the CreateCoipPoolResult structure.
     */
    static let __default: ElasticComputeCloudModel.CreateCoipPoolResult = {
        let defaultInstance = ElasticComputeCloudModel.CreateCoipPoolResult(
            coipPool: nil)
...
public extension CreateInstanceConnectEndpointRequest {
    /**
     Default instance of the CreateInstanceConnectEndpointRequest structure.
     */
    static let __default: ElasticComputeCloudModel.CreateInstanceConnectEndpointRequest = {
        let defaultInstance = ElasticComputeCloudModel.CreateInstanceConnectEndpointRequest(
            clientToken: nil,
            dryRun: nil,
...
public extension CreateInstanceConnectEndpointResult {
    /**
     Default instance of the CreateInstanceConnectEndpointResult structure.
     */
    static let __default: ElasticComputeCloudModel.CreateInstanceConnectEndpointResult = {
        let defaultInstance = ElasticComputeCloudModel.CreateInstanceConnectEndpointResult(
            clientToken: nil,
            instanceConnectEndpoint: nil)

        return defaultInstance
    }()
}

public extension CreateInstanceEventWindowRequest {
    /**
     Default instance of the CreateInstanceEventWindowRequest structure.
     */
    static let __default: ElasticComputeCloudModel.CreateInstanceEventWindowRequest = {
        let defaultInstance = ElasticComputeCloudModel.CreateInstanceEventWindowRequest(
            cronExpression: nil,
            dryRun: nil,
            name: nil,
            tagSpecifications: nil,
...
public extension CreateInstanceEventWindowResult {
    /**
     Default instance of the CreateInstanceEventWindowResult structure.
     */
    static let __default: ElasticComputeCloudModel.CreateInstanceEventWindowResult = {
        let defaultInstance = ElasticComputeCloudModel.CreateInstanceEventWindowResult(
            instanceEventWindow: nil)
...
public extension CreateInstanceExportTaskRequest {
    ...
    static let __default: ElasticComputeCloudModel.CreateInstanceExportTaskRequest = {
        let defaultInstance = ElasticComputeCloudModel.CreateInstanceExportTaskRequest(
            description: nil,
            exportToS3Task: ExportToS3TaskSpecification.__default,
            instanceId: "value",
            tagSpecifications: nil,
            targetEnvironment: .__default)
...
public extension CreateIpamPoolRequest {
    /**
     Default instance of the CreateIpamPoolRequest structure.
     */
    static let __default: ElasticComputeCloudModel.CreateIpamPoolRequest = {
        let defaultInstance = ElasticComputeCloudModel.CreateIpamPoolRequest(
            addressFamily: .__default,
...
public extension CreateIpamPoolResult {
    /**
     Default instance of the CreateIpamPoolResult structure.
     */
    static let __default: ElasticComputeCloudModel.CreateIpamPoolResult = {
        let defaultInstance = ElasticComputeCloudModel.CreateIpamPoolResult(
            ipamPool: nil)
...
public extension CreateIpamRequest {
    /**
     Default instance of the CreateIpamRequest structure.
     */
    static let __default: ElasticComputeCloudModel.CreateIpamRequest = {
        let defaultInstance = ElasticComputeCloudModel.CreateIpamRequest(
            clientToken: nil,
            description: nil,
            dryRun: nil,
...
public extension CreateIpamResourceDiscoveryRequest {
    /**
     Default instance of the CreateIpamResourceDiscoveryRequest structure.
     */
    static let __default: ElasticComputeCloudModel.CreateIpamResourceDiscoveryRequest = {
        let defaultInstance = ElasticComputeCloudModel.CreateIpamResourceDiscoveryRequest(
            clientToken: nil,
            description: nil,
            dryRun: nil,
            operatingRegions: nil,
...
public extension CreateIpamResourceDiscoveryResult {
    /**
     Default instance of the CreateIpamResourceDiscoveryResult structure.
     */
    static let __default: ElasticComputeCloudModel.CreateIpamResourceDiscoveryResult = {
        let defaultInstance = ElasticComputeCloudModel.CreateIpamResourceDiscoveryResult(
            ipamResourceDiscovery: nil)

        return defaultInstance
    }()
}

public extension CreateIpamResult {
    /**
     Default instance of the CreateIpamResult structure.
     */
    static let __default: ElasticComputeCloudModel.CreateIpamResult = {
        let defaultInstance = ElasticComputeCloudModel.CreateIpamResult(
            ipam: nil)
...
public extension CreateIpamScopeRequest {
    /**
     Default instance of the CreateIpamScopeRequest structure.
     */
    static let __default: ElasticComputeCloudModel.CreateIpamScopeRequest = {
        let defaultInstance = ElasticComputeCloudModel.CreateIpamScopeRequest(
            clientToken: nil,
            description: nil,
            dryRun: nil,
            ipamId: "value",
...
public extension CreateIpamScopeResult {
    /**
     Default instance of the CreateIpamScopeResult structure.
     */
    static let __default: ElasticComputeCloudModel.CreateIpamScopeResult = {
        let defaultInstance = ElasticComputeCloudModel.CreateIpamScopeResult(
            ipamScope: nil)
...
public extension CreateLocalGatewayRouteTableRequest {
    /**
     Default instance of the CreateLocalGatewayRouteTableRequest structure.
     */
    static let __default: ElasticComputeCloudModel.CreateLocalGatewayRouteTableRequest = {
        let defaultInstance = ElasticComputeCloudModel.CreateLocalGatewayRouteTableRequest(
            dryRun: nil,
...
public extension CreateLocalGatewayRouteTableResult {
    /**
     Default instance of the CreateLocalGatewayRouteTableResult structure.
     */
    static let __default: ElasticComputeCloudModel.CreateLocalGatewayRouteTableResult = {
        let defaultInstance = ElasticComputeCloudModel.CreateLocalGatewayRouteTableResult(
            localGatewayRouteTable: nil)

        return defaultInstance
    }()
}

public extension CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationRequest {
    /**
     Default instance of the CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationRequest structure.
     */
    static let __default: ElasticComputeCloudModel.CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationRequest = {
        let defaultInstance = ElasticComputeCloudModel.CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationRequest(
            dryRun: nil,
            localGatewayRouteTableId: "value",
...
public extension CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationResult {
    /**
     Default instance of the CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationResult structure.
     */
    static let __default: ElasticComputeCloudModel.CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationResult = {
        let defaultInstance = ElasticComputeCloudModel.CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationResult(
            localGatewayRouteTableVirtualInterfaceGroupAssociation: nil)
...
public extension CreateNetworkInsightsAccessScopeRequest {
    /**
     Default instance of the CreateNetworkInsightsAccessScopeRequest structure.
     */
    static let __default: ElasticComputeCloudModel.CreateNetworkInsightsAccessScopeRequest = {
        let defaultInstance = ElasticComputeCloudModel.CreateNetworkInsightsAccessScopeRequest(
            clientToken: "value",
            dryRun: nil,
            excludePaths: nil,
            matchPaths: nil,
...
public extension CreateNetworkInsightsAccessScopeResult {
    /**
     Default instance of the CreateNetworkInsightsAccessScopeResult structure.
     */
    static let __default: ElasticComputeCloudModel.CreateNetworkInsightsAccessScopeResult = {
        let defaultInstance = ElasticComputeCloudModel.CreateNetworkInsightsAccessScopeResult(
            networkInsightsAccessScope: nil,
            networkInsightsAccessScopeContent: nil)

        return defaultInstance
    }()
}

public extension CreateNetworkInsightsPathRequest {
    /**
     Default instance of the CreateNetworkInsightsPathRequest structure.
     */
    static let __default: ElasticComputeCloudModel.CreateNetworkInsightsPathRequest = {
        let defaultInstance = ElasticComputeCloudModel.CreateNetworkInsightsPathRequest(
            clientToken: "value",
            destination: nil,
            destinationIp: nil,
            destinationPort: nil,
            dryRun: nil,
            filterAtDestination: nil,
            filterAtSource: nil,
            protocol: .__default,
            source: "value",
            sourceIp: nil,
...
public extension CreateNetworkInsightsPathResult {
    /**
     Default instance of the CreateNetworkInsightsPathResult structure.
     */
    static let __default: ElasticComputeCloudModel.CreateNetworkInsightsPathResult = {
        let defaultInstance = ElasticComputeCloudModel.CreateNetworkInsightsPathResult(
            networkInsightsPath: nil)
...
public extension CreatePublicIpv4PoolRequest {
    /**
     Default instance of the CreatePublicIpv4PoolRequest structure.
     */
    static let __default: ElasticComputeCloudModel.CreatePublicIpv4PoolRequest = {
        let defaultInstance = ElasticComputeCloudModel.CreatePublicIpv4PoolRequest(
            dryRun: nil,
            tagSpecifications: nil)
...
public extension CreatePublicIpv4PoolResult {
    /**
     Default instance of the CreatePublicIpv4PoolResult structure.
     */
    static let __default: ElasticComputeCloudModel.CreatePublicIpv4PoolResult = {
        let defaultInstance = ElasticComputeCloudModel.CreatePublicIpv4PoolResult(
            poolId: nil)
...
public extension CreateSubnetCidrReservationRequest {
    /**
     Default instance of the CreateSubnetCidrReservationRequest structure.
     */
    static let __default: ElasticComputeCloudModel.CreateSubnetCidrReservationRequest = {
        let defaultInstance = ElasticComputeCloudModel.CreateSubnetCidrReservationRequest(
            cidr: "value",
            description: nil,
            dryRun: nil,
            reservationType: .__default,
            subnetId: "value",
            tagSpecifications: nil)
...
public extension CreateSubnetCidrReservationResult {
    /**
     Default instance of the CreateSubnetCidrReservationResult structure.
     */
    static let __default: ElasticComputeCloudModel.CreateSubnetCidrReservationResult = {
        let defaultInstance = ElasticComputeCloudModel.CreateSubnetCidrReservationResult(
            subnetCidrReservation: nil)
...
public extension CreateTrafficMirrorTargetRequest {
    ...
    static let __default: ElasticComputeCloudModel.CreateTrafficMirrorTargetRequest = {
        let defaultInstance = ElasticComputeCloudModel.CreateTrafficMirrorTargetRequest(
            ...
            description: nil,
            dryRun: nil,
            gatewayLoadBalancerEndpointId: nil,
            networkInterfaceId: nil,
...
public extension CreateTransitGatewayConnectPeerRequest {
    /**
     Default instance of the CreateTransitGatewayConnectPeerRequest structure.
     */
    static let __default: ElasticComputeCloudModel.CreateTransitGatewayConnectPeerRequest = {
        let defaultInstance = ElasticComputeCloudModel.CreateTransitGatewayConnectPeerRequest(
            bgpOptions: nil,
            dryRun: nil,
            insideCidrBlocks: [],
            peerAddress: "value",
            tagSpecifications: nil,
            transitGatewayAddress: nil,
            transitGatewayAttachmentId: "value")
...
public extension CreateTransitGatewayConnectPeerResult {
    /**
     Default instance of the CreateTransitGatewayConnectPeerResult structure.
     */
    static let __default: ElasticComputeCloudModel.CreateTransitGatewayConnectPeerResult = {
        let defaultInstance = ElasticComputeCloudModel.CreateTransitGatewayConnectPeerResult(
            transitGatewayConnectPeer: nil)

        return defaultInstance
    }()
}

public extension CreateTransitGatewayConnectRequest {
    /**
     Default instance of the CreateTransitGatewayConnectRequest structure.
     */
    static let __default: ElasticComputeCloudModel.CreateTransitGatewayConnectRequest = {
        let defaultInstance = ElasticComputeCloudModel.CreateTransitGatewayConnectRequest(
            dryRun: nil,
            options: CreateTransitGatewayConnectRequestOptions.__default,
            tagSpecifications: nil,
            transportTransitGatewayAttachmentId: "value")

        return defaultInstance
    }()
}

public extension CreateTransitGatewayConnectRequestOptions {
    /**
     Default instance of the CreateTransitGatewayConnectRequestOptions structure.
     */
    static let __default: ElasticComputeCloudModel.CreateTransitGatewayConnectRequestOptions = {
        let defaultInstance = ElasticComputeCloudModel.CreateTransitGatewayConnectRequestOptions(
            protocol: .__default)
...
public extension CreateTransitGatewayConnectResult {
    /**
     Default instance of the CreateTransitGatewayConnectResult structure.
     */
    static let __default: ElasticComputeCloudModel.CreateTransitGatewayConnectResult = {
        let defaultInstance = ElasticComputeCloudModel.CreateTransitGatewayConnectResult(
            transitGatewayConnect: nil)
...
public extension CreateTransitGatewayMulticastDomainRequestOptions {
    /**
     Default instance of the CreateTransitGatewayMulticastDomainRequestOptions structure.
     */
    static let __default: ElasticComputeCloudModel.CreateTransitGatewayMulticastDomainRequestOptions = {
        let defaultInstance = ElasticComputeCloudModel.CreateTransitGatewayMulticastDomainRequestOptions(
            autoAcceptSharedAssociations: nil,
            igmpv2Support: nil,
            staticSourcesSupport: nil)
...
public extension CreateTransitGatewayPeeringAttachmentRequestOptions {
    /**
     Default instance of the CreateTransitGatewayPeeringAttachmentRequestOptions structure.
     */
    static let __default: ElasticComputeCloudModel.CreateTransitGatewayPeeringAttachmentRequestOptions = {
        let defaultInstance = ElasticComputeCloudModel.CreateTransitGatewayPeeringAttachmentRequestOptions(
            dynamicRouting: nil)
...
public extension CreateTransitGatewayPolicyTableRequest {
    /**
     Default instance of the CreateTransitGatewayPolicyTableRequest structure.
     */
    static let __default: ElasticComputeCloudModel.CreateTransitGatewayPolicyTableRequest = {
        let defaultInstance = ElasticComputeCloudModel.CreateTransitGatewayPolicyTableRequest(
            dryRun: nil,
            tagSpecifications: nil,
            transitGatewayId: "value")
...
public extension CreateTransitGatewayPolicyTableResult {
    /**
     Default instance of the CreateTransitGatewayPolicyTableResult structure.
     */
    static let __default: ElasticComputeCloudModel.CreateTransitGatewayPolicyTableResult = {
        let defaultInstance = ElasticComputeCloudModel.CreateTransitGatewayPolicyTableResult(
            transitGatewayPolicyTable: nil)
...
public extension CreateTransitGatewayRouteTableAnnouncementRequest {
    /**
     Default instance of the CreateTransitGatewayRouteTableAnnouncementRequest structure.
     */
    static let __default: ElasticComputeCloudModel.CreateTransitGatewayRouteTableAnnouncementRequest = {
        let defaultInstance = ElasticComputeCloudModel.CreateTransitGatewayRouteTableAnnouncementRequest(
            dryRun: nil,
            peeringAttachmentId: "value",
            tagSpecifications: nil,
            transitGatewayRouteTableId: "value")
...
public extension CreateTransitGatewayRouteTableAnnouncementResult {
    /**
     Default instance of the CreateTransitGatewayRouteTableAnnouncementResult structure.
     */
    static let __default: ElasticComputeCloudModel.CreateTransitGatewayRouteTableAnnouncementResult = {
        let defaultInstance = ElasticComputeCloudModel.CreateTransitGatewayRouteTableAnnouncementResult(
            transitGatewayRouteTableAnnouncement: nil)
...
public extension DeleteCoipCidrRequest {
    /**
     Default instance of the DeleteCoipCidrRequest structure.
     */
    static let __default: ElasticComputeCloudModel.DeleteCoipCidrRequest = {
        let defaultInstance = ElasticComputeCloudModel.DeleteCoipCidrRequest(
            cidr: "value",
            coipPoolId: "value",
            dryRun: nil)
...
public extension DeleteCoipCidrResult {
    /**
     Default instance of the DeleteCoipCidrResult structure.
     */
    static let __default: ElasticComputeCloudModel.DeleteCoipCidrResult = {
        let defaultInstance = ElasticComputeCloudModel.DeleteCoipCidrResult(
            coipCidr: nil)
...
public extension DeleteCoipPoolRequest {
    /**
     Default instance of the DeleteCoipPoolRequest structure.
     */
    static let __default: ElasticComputeCloudModel.DeleteCoipPoolRequest = {
        let defaultInstance = ElasticComputeCloudModel.DeleteCoipPoolRequest(
            coipPoolId: "value",
            dryRun: nil)
...
public extension DeleteCoipPoolResult {
    /**
     Default instance of the DeleteCoipPoolResult structure.
     */
    static let __default: ElasticComputeCloudModel.DeleteCoipPoolResult = {
        let defaultInstance = ElasticComputeCloudModel.DeleteCoipPoolResult(
            coipPool: nil)
...
public extension DeleteInstanceConnectEndpointRequest {
    /**
     Default instance of the DeleteInstanceConnectEndpointRequest structure.
     */
    static let __default: ElasticComputeCloudModel.DeleteInstanceConnectEndpointRequest = {
        let defaultInstance = ElasticComputeCloudModel.DeleteInstanceConnectEndpointRequest(
            dryRun: nil,
            instanceConnectEndpointId: "value")

        return defaultInstance
    }()
}

public extension DeleteInstanceConnectEndpointResult {
    /**
     Default instance of the DeleteInstanceConnectEndpointResult structure.
     */
    static let __default: ElasticComputeCloudModel.DeleteInstanceConnectEndpointResult = {
        let defaultInstance = ElasticComputeCloudModel.DeleteInstanceConnectEndpointResult(
            instanceConnectEndpoint: nil)
...
public extension DeleteInstanceEventWindowRequest {
    /**
     Default instance of the DeleteInstanceEventWindowRequest structure.
     */
    static let __default: ElasticComputeCloudModel.DeleteInstanceEventWindowRequest = {
        let defaultInstance = ElasticComputeCloudModel.DeleteInstanceEventWindowRequest(
            dryRun: nil,
            forceDelete: nil,
            instanceEventWindowId: "value")
...
public extension DeleteInstanceEventWindowResult {
    /**
     Default instance of the DeleteInstanceEventWindowResult structure.
     */
    static let __default: ElasticComputeCloudModel.DeleteInstanceEventWindowResult = {
        let defaultInstance = ElasticComputeCloudModel.DeleteInstanceEventWindowResult(
            instanceEventWindowState: nil)
...
public extension DeleteIpamPoolRequest {
    /**
     Default instance of the DeleteIpamPoolRequest structure.
     */
    static let __default: ElasticComputeCloudModel.DeleteIpamPoolRequest = {
        let defaultInstance = ElasticComputeCloudModel.DeleteIpamPoolRequest(
            dryRun: nil,
            ipamPoolId: "value")
...
public extension DeleteIpamPoolResult {
    /**
     Default instance of the DeleteIpamPoolResult structure.
     */
    static let __default: ElasticComputeCloudModel.DeleteIpamPoolResult = {
        let defaultInstance = ElasticComputeCloudModel.DeleteIpamPoolResult(
            ipamPool: nil)
...
public extension DeleteIpamRequest {
    /**
     Default instance of the DeleteIpamRequest structure.
     */
    static let __default: ElasticComputeCloudModel.DeleteIpamRequest = {
        let defaultInstance = ElasticComputeCloudModel.DeleteIpamRequest(
            cascade: nil,
            dryRun: nil,
            ipamId: "value")
...
public extension DeleteIpamResourceDiscoveryRequest {
    /**
     Default instance of the DeleteIpamResourceDiscoveryRequest structure.
     */
    static let __default: ElasticComputeCloudModel.DeleteIpamResourceDiscoveryRequest = {
        let defaultInstance = ElasticComputeCloudModel.DeleteIpamResourceDiscoveryRequest(
            dryRun: nil,
            ipamResourceDiscoveryId: "value")
...
public extension DeleteIpamResourceDiscoveryResult {
    /**
     Default instance of the DeleteIpamResourceDiscoveryResult structure.
     */
    static let __default: ElasticComputeCloudModel.DeleteIpamResourceDiscoveryResult = {
        let defaultInstance = ElasticComputeCloudModel.DeleteIpamResourceDiscoveryResult(
            ipamResourceDiscovery: nil)
...
public extension DeleteIpamResult {
    /**
     Default instance of the DeleteIpamResult structure.
     */
    static let __default: ElasticComputeCloudModel.DeleteIpamResult = {
        let defaultInstance = ElasticComputeCloudModel.DeleteIpamResult(
            ipam: nil)
...
public extension DeleteIpamScopeRequest {
    /**
     Default instance of the DeleteIpamScopeRequest structure.
     */
    static let __default: ElasticComputeCloudModel.DeleteIpamScopeRequest = {
        let defaultInstance = ElasticComputeCloudModel.DeleteIpamScopeRequest(
            dryRun: nil,
            ipamScopeId: "value")
...
public extension DeleteIpamScopeResult {
    /**
     Default instance of the DeleteIpamScopeResult structure.
     */
    static let __default: ElasticComputeCloudModel.DeleteIpamScopeResult = {
        let defaultInstance = ElasticComputeCloudModel.DeleteIpamScopeResult(
            ipamScope: nil)
...
public extension DeleteKeyPairResult {
    /**
     Default instance of the DeleteKeyPairResult structure.
     */
    static let __default: ElasticComputeCloudModel.DeleteKeyPairResult = {
        let defaultInstance = ElasticComputeCloudModel.DeleteKeyPairResult(
            keyPairId: nil,
            return: nil)
...
public extension DeleteLocalGatewayRouteTableRequest {
    /**
     Default instance of the DeleteLocalGatewayRouteTableRequest structure.
     */
    static let __default: ElasticComputeCloudModel.DeleteLocalGatewayRouteTableRequest = {
        let defaultInstance = ElasticComputeCloudModel.DeleteLocalGatewayRouteTableRequest(
            dryRun: nil,
            localGatewayRouteTableId: "value")
...
public extension DeleteLocalGatewayRouteTableResult {
    /**
     Default instance of the DeleteLocalGatewayRouteTableResult structure.
     */
    static let __default: ElasticComputeCloudModel.DeleteLocalGatewayRouteTableResult = {
        let defaultInstance = ElasticComputeCloudModel.DeleteLocalGatewayRouteTableResult(
            localGatewayRouteTable: nil)
...
public extension DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationRequest {
    /**
     Default instance of the DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationRequest structure.
     */
    static let __default: ElasticComputeCloudModel.DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationRequest = {
        let defaultInstance = ElasticComputeCloudModel.DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationRequest(
            dryRun: nil,
...
public extension DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationResult {
    /**
     Default instance of the DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationResult structure.
     */
    static let __default: ElasticComputeCloudModel.DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationResult = {
        let defaultInstance = ElasticComputeCloudModel.DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationResult(
            localGatewayRouteTableVirtualInterfaceGroupAssociation: nil)
...
public extension DeleteNetworkInsightsAccessScopeAnalysisRequest {
    /**
     Default instance of the DeleteNetworkInsightsAccessScopeAnalysisRequest structure.
     */
    static let __default: ElasticComputeCloudModel.DeleteNetworkInsightsAccessScopeAnalysisRequest = {
        let defaultInstance = ElasticComputeCloudModel.DeleteNetworkInsightsAccessScopeAnalysisRequest(
            dryRun: nil,
            networkInsightsAccessScopeAnalysisId: "value")

        return defaultInstance
    }()
}

public extension DeleteNetworkInsightsAccessScopeAnalysisResult {
    /**
     Default instance of the DeleteNetworkInsightsAccessScopeAnalysisResult structure.
     */
    static let __default: ElasticComputeCloudModel.DeleteNetworkInsightsAccessScopeAnalysisResult = {
        let defaultInstance = ElasticComputeCloudModel.DeleteNetworkInsightsAccessScopeAnalysisResult(
            networkInsightsAccessScopeAnalysisId: nil)
...
public extension DeleteNetworkInsightsAccessScopeRequest {
    /**
     Default instance of the DeleteNetworkInsightsAccessScopeRequest structure.
     */
    static let __default: ElasticComputeCloudModel.DeleteNetworkInsightsAccessScopeRequest = {
        let defaultInstance = ElasticComputeCloudModel.DeleteNetworkInsightsAccessScopeRequest(
            dryRun: nil,
            networkInsightsAccessScopeId: "value")

        return defaultInstance
    }()
}

public extension DeleteNetworkInsightsAccessScopeResult {
    /**
     Default instance of the DeleteNetworkInsightsAccessScopeResult structure.
     */
    static let __default: ElasticComputeCloudModel.DeleteNetworkInsightsAccessScopeResult = {
        let defaultInstance = ElasticComputeCloudModel.DeleteNetworkInsightsAccessScopeResult(
            networkInsightsAccessScopeId: nil)
...
public extension DeleteNetworkInsightsAnalysisRequest {
    /**
     Default instance of the DeleteNetworkInsightsAnalysisRequest structure.
     */
    static let __default: ElasticComputeCloudModel.DeleteNetworkInsightsAnalysisRequest = {
        let defaultInstance = ElasticComputeCloudModel.DeleteNetworkInsightsAnalysisRequest(
            dryRun: nil,
            networkInsightsAnalysisId: "value")

        return defaultInstance
    }()
}

public extension DeleteNetworkInsightsAnalysisResult {
    /**
     Default instance of the DeleteNetworkInsightsAnalysisResult structure.
     */
    static let __default: ElasticComputeCloudModel.DeleteNetworkInsightsAnalysisResult = {
        let defaultInstance = ElasticComputeCloudModel.DeleteNetworkInsightsAnalysisResult(
            networkInsightsAnalysisId: nil)

        return defaultInstance
    }()
}

public extension DeleteNetworkInsightsPathRequest {
    /**
     Default instance of the DeleteNetworkInsightsPathRequest structure.
     */
    static let __default: ElasticComputeCloudModel.DeleteNetworkInsightsPathRequest = {
        let defaultInstance = ElasticComputeCloudModel.DeleteNetworkInsightsPathRequest(
            dryRun: nil,
            networkInsightsPathId: "value")

        return defaultInstance
    }()
}

public extension DeleteNetworkInsightsPathResult {
    /**
     Default instance of the DeleteNetworkInsightsPathResult structure.
     */
    static let __default: ElasticComputeCloudModel.DeleteNetworkInsightsPathResult = {
        let defaultInstance = ElasticComputeCloudModel.DeleteNetworkInsightsPathResult(
...
public extension DeletePublicIpv4PoolRequest {
    /**
     Default instance of the DeletePublicIpv4PoolRequest structure.
     */
    static let __default: ElasticComputeCloudModel.DeletePublicIpv4PoolRequest = {
        let defaultInstance = ElasticComputeCloudModel.DeletePublicIpv4PoolRequest(
            dryRun: nil,
            poolId: "value")
...
public extension DeletePublicIpv4PoolResult {
    /**
     Default instance of the DeletePublicIpv4PoolResult structure.
     */
    static let __default: ElasticComputeCloudModel.DeletePublicIpv4PoolResult = {
        let defaultInstance = ElasticComputeCloudModel.DeletePublicIpv4PoolResult(
            returnValue: nil)
...
public extension DeleteSubnetCidrReservationRequest {
    /**
     Default instance of the DeleteSubnetCidrReservationRequest structure.
     */
    static let __default: ElasticComputeCloudModel.DeleteSubnetCidrReservationRequest = {
        let defaultInstance = ElasticComputeCloudModel.DeleteSubnetCidrReservationRequest(
            dryRun: nil,
            subnetCidrReservationId: "value")

        return defaultInstance
    }()
}

public extension DeleteSubnetCidrReservationResult {
    /**
     Default instance of the DeleteSubnetCidrReservationResult structure.
     */
    static let __default: ElasticComputeCloudModel.DeleteSubnetCidrReservationResult = {
        let defaultInstance = ElasticComputeCloudModel.DeleteSubnetCidrReservationResult(
            deletedSubnetCidrReservation: nil)
...
public extension DeleteTransitGatewayConnectPeerRequest {
    /**
     Default instance of the DeleteTransitGatewayConnectPeerRequest structure.
     */
    static let __default: ElasticComputeCloudModel.DeleteTransitGatewayConnectPeerRequest = {
        let defaultInstance = ElasticComputeCloudModel.DeleteTransitGatewayConnectPeerRequest(
            dryRun: nil,
            transitGatewayConnectPeerId: "value")

        return defaultInstance
    }()
}

public extension DeleteTransitGatewayConnectPeerResult {
    /**
     Default instance of the DeleteTransitGatewayConnectPeerResult structure.
     */
    static let __default: ElasticComputeCloudModel.DeleteTransitGatewayConnectPeerResult = {
        let defaultInstance = ElasticComputeCloudModel.DeleteTransitGatewayConnectPeerResult(
            transitGatewayConnectPeer: nil)
...
public extension DeleteTransitGatewayConnectRequest {
    /**
     Default instance of the DeleteTransitGatewayConnectRequest structure.
     */
    static let __default: ElasticComputeCloudModel.DeleteTransitGatewayConnectRequest = {
        let defaultInstance = ElasticComputeCloudModel.DeleteTransitGatewayConnectRequest(
            dryRun: nil,
            transitGatewayAttachmentId: "value")
...
public extension DeleteTransitGatewayConnectResult {
    /**
     Default instance of the DeleteTransitGatewayConnectResult structure.
     */
    static let __default: ElasticComputeCloudModel.DeleteTransitGatewayConnectResult = {
        let defaultInstance = ElasticComputeCloudModel.DeleteTransitGatewayConnectResult(
            transitGatewayConnect: nil)
...
public extension DeleteTransitGatewayPolicyTableRequest {
    /**
     Default instance of the DeleteTransitGatewayPolicyTableRequest structure.
     */
    static let __default: ElasticComputeCloudModel.DeleteTransitGatewayPolicyTableRequest = {
        let defaultInstance = ElasticComputeCloudModel.DeleteTransitGatewayPolicyTableRequest(
            dryRun: nil,
            transitGatewayPolicyTableId: "value")
...
public extension DeleteTransitGatewayPolicyTableResult {
    /**
     Default instance of the DeleteTransitGatewayPolicyTableResult structure.
     */
    static let __default: ElasticComputeCloudModel.DeleteTransitGatewayPolicyTableResult = {
        let defaultInstance = ElasticComputeCloudModel.DeleteTransitGatewayPolicyTableResult(
            transitGatewayPolicyTable: nil)
...
public extension DeleteTransitGatewayRouteTableAnnouncementRequest {
    /**
     Default instance of the DeleteTransitGatewayRouteTableAnnouncementRequest structure.
     */
    static let __default: ElasticComputeCloudModel.DeleteTransitGatewayRouteTableAnnouncementRequest = {
        let defaultInstance = ElasticComputeCloudModel.DeleteTransitGatewayRouteTableAnnouncementRequest(
            dryRun: nil,
...
public extension DeleteTransitGatewayRouteTableAnnouncementResult {
    /**
     Default instance of the DeleteTransitGatewayRouteTableAnnouncementResult structure.
     */
    static let __default: ElasticComputeCloudModel.DeleteTransitGatewayRouteTableAnnouncementResult = {
        let defaultInstance = ElasticComputeCloudModel.DeleteTransitGatewayRouteTableAnnouncementResult(
            transitGatewayRouteTableAnnouncement: nil)
...
public extension DeprovisionIpamPoolCidrRequest {
    /**
     Default instance of the DeprovisionIpamPoolCidrRequest structure.
     */
    static let __default: ElasticComputeCloudModel.DeprovisionIpamPoolCidrRequest = {
        let defaultInstance = ElasticComputeCloudModel.DeprovisionIpamPoolCidrRequest(
            cidr: nil,
            dryRun: nil,
            ipamPoolId: "value")
...
public extension DeprovisionIpamPoolCidrResult {
    /**
     Default instance of the DeprovisionIpamPoolCidrResult structure.
     */
    static let __default: ElasticComputeCloudModel.DeprovisionIpamPoolCidrResult = {
        let defaultInstance = ElasticComputeCloudModel.DeprovisionIpamPoolCidrResult(
            ipamPoolCidr: nil)
...
public extension DeprovisionPublicIpv4PoolCidrRequest {
    /**
     Default instance of the DeprovisionPublicIpv4PoolCidrRequest structure.
     */
    static let __default: ElasticComputeCloudModel.DeprovisionPublicIpv4PoolCidrRequest = {
        let defaultInstance = ElasticComputeCloudModel.DeprovisionPublicIpv4PoolCidrRequest(
            cidr: "value",
            dryRun: nil,
            poolId: "value")
...
public extension DeprovisionPublicIpv4PoolCidrResult {
    /**
     Default instance of the DeprovisionPublicIpv4PoolCidrResult structure.
     */
    static let __default: ElasticComputeCloudModel.DeprovisionPublicIpv4PoolCidrResult = {
        let defaultInstance = ElasticComputeCloudModel.DeprovisionPublicIpv4PoolCidrResult(
...
public extension DeregisterInstanceEventNotificationAttributesRequest {
    ...
    static let __default: ElasticComputeCloudModel.DeregisterInstanceEventNotificationAttributesRequest = {
        let defaultInstance = ElasticComputeCloudModel.DeregisterInstanceEventNotificationAttributesRequest(
            dryRun: nil,
            instanceTagAttribute: DeregisterInstanceTagAttributeRequest.__default)
...
public extension DescribeFastLaunchImagesRequest {
    /**
     Default instance of the DescribeFastLaunchImagesRequest structure.
     */
    static let __default: ElasticComputeCloudModel.DescribeFastLaunchImagesRequest = {
        let defaultInstance = ElasticComputeCloudModel.DescribeFastLaunchImagesRequest(
            dryRun: nil,
            filters: nil,
            imageIds: nil,
            maxResults: nil,
...
public extension DescribeFastLaunchImagesResult {
    /**
     Default instance of the DescribeFastLaunchImagesResult structure.
     */
    static let __default: ElasticComputeCloudModel.DescribeFastLaunchImagesResult = {
        let defaultInstance = ElasticComputeCloudModel.DescribeFastLaunchImagesResult(
...
public extension DescribeFastLaunchImagesSuccessItem {
    /**
     Default instance of the DescribeFastLaunchImagesSuccessItem structure.
     */
    static let __default: ElasticComputeCloudModel.DescribeFastLaunchImagesSuccessItem = {
        let defaultInstance = ElasticComputeCloudModel.DescribeFastLaunchImagesSuccessItem(
            imageId: nil,
            launchTemplate: nil,
            maxParallelLaunches: nil,
            ownerId: nil,
            resourceType: nil,
...
public extension DescribeInstanceConnectEndpointsRequest {
    /**
     Default instance of the DescribeInstanceConnectEndpointsRequest structure.
     */
    static let __default: ElasticComputeCloudModel.DescribeInstanceConnectEndpointsRequest = {
        let defaultInstance = ElasticComputeCloudModel.DescribeInstanceConnectEndpointsRequest(
            dryRun: nil,
            filters: nil,
            instanceConnectEndpointIds: nil,
            maxResults: nil,
            nextToken: nil)
...
public extension DescribeInstanceConnectEndpointsResult {
    /**
     Default instance of the DescribeInstanceConnectEndpointsResult structure.
     */
    static let __default: ElasticComputeCloudModel.DescribeInstanceConnectEndpointsResult = {
        let defaultInstance = ElasticComputeCloudModel.DescribeInstanceConnectEndpointsResult(
            instanceConnectEndpoints: nil,
            nextToken: nil)
...
public extension DescribeInstanceEventWindowsRequest {
    /**
     Default instance of the DescribeInstanceEventWindowsRequest structure.
     */
    static let __default: ElasticComputeCloudModel.DescribeInstanceEventWindowsRequest = {
        let defaultInstance = ElasticComputeCloudModel.DescribeInstanceEventWindowsRequest(
            dryRun: nil,
            filters: nil,
            instanceEventWindowIds: nil,
            maxResults: nil,
            nextToken: nil)
...
public extension DescribeInstanceEventWindowsResult {
    /**
     Default instance of the DescribeInstanceEventWindowsResult structure.
     */
    static let __default: ElasticComputeCloudModel.DescribeInstanceEventWindowsResult = {
        let defaultInstance = ElasticComputeCloudModel.DescribeInstanceEventWindowsResult(
...
public extension DescribeIpamPoolsRequest {
    /**
     Default instance of the DescribeIpamPoolsRequest structure.
     */
    static let __default: ElasticComputeCloudModel.DescribeIpamPoolsRequest = {
        let defaultInstance = ElasticComputeCloudModel.DescribeIpamPoolsRequest(
            dryRun: nil,
            filters: nil,
            ipamPoolIds: nil,
            maxResults: nil,
...
public extension DescribeIpamPoolsResult {
    /**
     Default instance of the DescribeIpamPoolsResult structure.
     */
    static let __default: ElasticComputeCloudModel.DescribeIpamPoolsResult = {
        let defaultInstance = ElasticComputeCloudModel.DescribeIpamPoolsResult(
            ipamPools: nil,
            nextToken: nil)
...
public extension DescribeIpamResourceDiscoveriesRequest {
    /**
     Default instance of the DescribeIpamResourceDiscoveriesRequest structure.
     */
    static let __default: ElasticComputeCloudModel.DescribeIpamResourceDiscoveriesRequest = {
        let defaultInstance = ElasticComputeCloudModel.DescribeIpamResourceDiscoveriesRequest(
            dryRun: nil,
            filters: nil,
            ipamResourceDiscoveryIds: nil,
            maxResults: nil,
            nextToken: nil)
...
public extension DescribeIpamResourceDiscoveriesResult {
    /**
     Default instance of the DescribeIpamResourceDiscoveriesResult structure.
     */
    static let __default: ElasticComputeCloudModel.DescribeIpamResourceDiscoveriesResult = {
        let defaultInstance = ElasticComputeCloudModel.DescribeIpamResourceDiscoveriesResult(
            ipamResourceDiscoveries: nil,
            nextToken: nil)
...
public extension DescribeIpamResourceDiscoveryAssociationsRequest {
    /**
     Default instance of the DescribeIpamResourceDiscoveryAssociationsRequest structure.
     */
    static let __default: ElasticComputeCloudModel.DescribeIpamResourceDiscoveryAssociationsRequest = {
        let defaultInstance = ElasticComputeCloudModel.DescribeIpamResourceDiscoveryAssociationsRequest(
            dryRun: nil,
            filters: nil,
            ipamResourceDiscoveryAssociationIds: nil,
            maxResults: nil,
            nextToken: nil)
...
public extension DescribeIpamResourceDiscoveryAssociationsResult {
    /**
     Default instance of the DescribeIpamResourceDiscoveryAssociationsResult structure.
     */
    static let __default: ElasticComputeCloudModel.DescribeIpamResourceDiscoveryAssociationsResult = {
        let defaultInstance = ElasticComputeCloudModel.DescribeIpamResourceDiscoveryAssociationsResult(
            ipamResourceDiscoveryAssociations: nil,
            nextToken: nil)
...
public extension DescribeIpamScopesRequest {
    /**
     Default instance of the DescribeIpamScopesRequest structure.
     */
    static let __default: ElasticComputeCloudModel.DescribeIpamScopesRequest = {
        let defaultInstance = ElasticComputeCloudModel.DescribeIpamScopesRequest(
            dryRun: nil,
            filters: nil,
            ipamScopeIds: nil,
            maxResults: nil,
...
public extension DescribeIpamScopesResult {
    /**
     Default instance of the DescribeIpamScopesResult structure.
     */
    static let __default: ElasticComputeCloudModel.DescribeIpamScopesResult = {
        let defaultInstance = ElasticComputeCloudModel.DescribeIpamScopesResult(
            ipamScopes: nil,
            nextToken: nil)
...
public extension DescribeIpamsRequest {
    /**
     Default instance of the DescribeIpamsRequest structure.
     */
    static let __default: ElasticComputeCloudModel.DescribeIpamsRequest = {
        let defaultInstance = ElasticComputeCloudModel.DescribeIpamsRequest(
            dryRun: nil,
            filters: nil,
            ipamIds: nil,
            maxResults: nil,
...
public extension DescribeIpamsResult {
    /**
     Default instance of the DescribeIpamsResult structure.
     */
    static let __default: ElasticComputeCloudModel.DescribeIpamsResult = {
        let defaultInstance = ElasticComputeCloudModel.DescribeIpamsResult(
            ipams: nil,
            nextToken: nil)
...
public extension DescribeNetworkInsightsAccessScopeAnalysesRequest {
    /**
     Default instance of the DescribeNetworkInsightsAccessScopeAnalysesRequest structure.
     */
    static let __default: ElasticComputeCloudModel.DescribeNetworkInsightsAccessScopeAnalysesRequest = {
        let defaultInstance = ElasticComputeCloudModel.DescribeNetworkInsightsAccessScopeAnalysesRequest(
            analysisStartTimeBegin: nil,
            analysisStartTimeEnd: nil,
            dryRun: nil,
            filters: nil,
            maxResults: nil,
...
public extension DescribeNetworkInsightsAccessScopeAnalysesResult {
    /**
     Default instance of the DescribeNetworkInsightsAccessScopeAnalysesResult structure.
     */
    static let __default: ElasticComputeCloudModel.DescribeNetworkInsightsAccessScopeAnalysesResult = {
        let defaultInstance = ElasticComputeCloudModel.DescribeNetworkInsightsAccessScopeAnalysesResult(
...
public extension DescribeNetworkInsightsAccessScopesRequest {
    /**
     Default instance of the DescribeNetworkInsightsAccessScopesRequest structure.
     */
    static let __default: ElasticComputeCloudModel.DescribeNetworkInsightsAccessScopesRequest = {
        let defaultInstance = ElasticComputeCloudModel.DescribeNetworkInsightsAccessScopesRequest(
            dryRun: nil,
            filters: nil,
            maxResults: nil,
            networkInsightsAccessScopeIds: nil,
            nextToken: nil)
...
public extension DescribeNetworkInsightsAccessScopesResult {
    /**
     Default instance of the DescribeNetworkInsightsAccessScopesResult structure.
     */
    static let __default: ElasticComputeCloudModel.DescribeNetworkInsightsAccessScopesResult = {
        let defaultInstance = ElasticComputeCloudModel.DescribeNetworkInsightsAccessScopesResult(
...
public extension DescribeNetworkInsightsAnalysesRequest {
    /**
     Default instance of the DescribeNetworkInsightsAnalysesRequest structure.
     */
    static let __default: ElasticComputeCloudModel.DescribeNetworkInsightsAnalysesRequest = {
        let defaultInstance = ElasticComputeCloudModel.DescribeNetworkInsightsAnalysesRequest(
            analysisEndTime: nil,
...
public extension DescribeNetworkInsightsAnalysesResult {
    /**
     Default instance of the DescribeNetworkInsightsAnalysesResult structure.
     */
    static let __default: ElasticComputeCloudModel.DescribeNetworkInsightsAnalysesResult = {
        let defaultInstance = ElasticComputeCloudModel.DescribeNetworkInsightsAnalysesResult(
...
public extension DescribeNetworkInsightsPathsRequest {
    /**
     Default instance of the DescribeNetworkInsightsPathsRequest structure.
     */
    static let __default: ElasticComputeCloudModel.DescribeNetworkInsightsPathsRequest = {
        let defaultInstance = ElasticComputeCloudModel.DescribeNetworkInsightsPathsRequest(
            dryRun: nil,
            filters: nil,
            maxResults: nil,
...
public extension DescribeNetworkInsightsPathsResult {
    /**
     Default instance of the DescribeNetworkInsightsPathsResult structure.
     */
    static let __default: ElasticComputeCloudModel.DescribeNetworkInsightsPathsResult = {
        let defaultInstance = ElasticComputeCloudModel.DescribeNetworkInsightsPathsResult(
...
public extension DescribeSecurityGroupRulesRequest {
    /**
     Default instance of the DescribeSecurityGroupRulesRequest structure.
     */
    static let __default: ElasticComputeCloudModel.DescribeSecurityGroupRulesRequest = {
        let defaultInstance = ElasticComputeCloudModel.DescribeSecurityGroupRulesRequest(
            dryRun: nil,
            filters: nil,
            maxResults: nil,
            nextToken: nil,
...
public extension DescribeSecurityGroupRulesResult {
    /**
     Default instance of the DescribeSecurityGroupRulesResult structure.
     */
    static let __default: ElasticComputeCloudModel.DescribeSecurityGroupRulesResult = {
        let defaultInstance = ElasticComputeCloudModel.DescribeSecurityGroupRulesResult(
            nextToken: nil,
            securityGroupRules: nil)
...
public extension DescribeSnapshotTierStatusRequest {
    /**
     Default instance of the DescribeSnapshotTierStatusRequest structure.
     */
    static let __default: ElasticComputeCloudModel.DescribeSnapshotTierStatusRequest = {
        let defaultInstance = ElasticComputeCloudModel.DescribeSnapshotTierStatusRequest(
            dryRun: nil,
            filters: nil,
            maxResults: nil,
            nextToken: nil)
...
public extension DescribeSnapshotTierStatusResult {
    /**
     Default instance of the DescribeSnapshotTierStatusResult structure.
     */
    static let __default: ElasticComputeCloudModel.DescribeSnapshotTierStatusResult = {
        let defaultInstance = ElasticComputeCloudModel.DescribeSnapshotTierStatusResult(
            nextToken: nil,
...
public extension DescribeTransitGatewayConnectPeersRequest {
    /**
     Default instance of the DescribeTransitGatewayConnectPeersRequest structure.
     */
    static let __default: ElasticComputeCloudModel.DescribeTransitGatewayConnectPeersRequest = {
        let defaultInstance = ElasticComputeCloudModel.DescribeTransitGatewayConnectPeersRequest(
            dryRun: nil,
            filters: nil,
            maxResults: nil,
            nextToken: nil,
            transitGatewayConnectPeerIds: nil)

        return defaultInstance
    }()
}

public extension DescribeTransitGatewayConnectPeersResult {
    /**
     Default instance of the DescribeTransitGatewayConnectPeersResult structure.
     */
    static let __default: ElasticComputeCloudModel.DescribeTransitGatewayConnectPeersResult = {
        let defaultInstance = ElasticComputeCloudModel.DescribeTransitGatewayConnectPeersResult(
            nextToken: nil,
...
public extension DescribeTransitGatewayConnectsRequest {
    /**
     Default instance of the DescribeTransitGatewayConnectsRequest structure.
     */
    static let __default: ElasticComputeCloudModel.DescribeTransitGatewayConnectsRequest = {
        let defaultInstance = ElasticComputeCloudModel.DescribeTransitGatewayConnectsRequest(
            dryRun: nil,
            filters: nil,
            maxResults: nil,
            nextToken: nil,
...
public extension DescribeTransitGatewayConnectsResult {
    /**
     Default instance of the DescribeTransitGatewayConnectsResult structure.
     */
    static let __default: ElasticComputeCloudModel.DescribeTransitGatewayConnectsResult = {
        let defaultInstance = ElasticComputeCloudModel.DescribeTransitGatewayConnectsResult(
            nextToken: nil,
...
public extension DescribeTransitGatewayPolicyTablesRequest {
    /**
     Default instance of the DescribeTransitGatewayPolicyTablesRequest structure.
     */
    static let __default: ElasticComputeCloudModel.DescribeTransitGatewayPolicyTablesRequest = {
        let defaultInstance = ElasticComputeCloudModel.DescribeTransitGatewayPolicyTablesRequest(
            dryRun: nil,
            filters: nil,
            maxResults: nil,
            nextToken: nil,
...
public extension DescribeTransitGatewayPolicyTablesResult {
    /**
     Default instance of the DescribeTransitGatewayPolicyTablesResult structure.
     */
    static let __default: ElasticComputeCloudModel.DescribeTransitGatewayPolicyTablesResult = {
        let defaultInstance = ElasticComputeCloudModel.DescribeTransitGatewayPolicyTablesResult(
            nextToken: nil,
...
public extension DescribeTransitGatewayRouteTableAnnouncementsRequest {
    /**
     Default instance of the DescribeTransitGatewayRouteTableAnnouncementsRequest structure.
     */
    static let __default: ElasticComputeCloudModel.DescribeTransitGatewayRouteTableAnnouncementsRequest = {
        let defaultInstance = ElasticComputeCloudModel.DescribeTransitGatewayRouteTableAnnouncementsRequest(
            dryRun: nil,
            filters: nil,
            maxResults: nil,
            nextToken: nil,
...
public extension DescribeTransitGatewayRouteTableAnnouncementsResult {
    /**
     Default instance of the DescribeTransitGatewayRouteTableAnnouncementsResult structure.
     */
    static let __default: ElasticComputeCloudModel.DescribeTransitGatewayRouteTableAnnouncementsResult = {
        let defaultInstance = ElasticComputeCloudModel.DescribeTransitGatewayRouteTableAnnouncementsResult(
            nextToken: nil,
...
public extension DisableFastLaunchRequest {
    /**
     Default instance of the DisableFastLaunchRequest structure.
     */
    static let __default: ElasticComputeCloudModel.DisableFastLaunchRequest = {
        let defaultInstance = ElasticComputeCloudModel.DisableFastLaunchRequest(
            dryRun: nil,
            force: nil,
            imageId: "value")
...
public extension DisableFastLaunchResult {
    /**
     Default instance of the DisableFastLaunchResult structure.
     */
    static let __default: ElasticComputeCloudModel.DisableFastLaunchResult = {
        let defaultInstance = ElasticComputeCloudModel.DisableFastLaunchResult(
            imageId: nil,
            launchTemplate: nil,
            maxParallelLaunches: nil,
            ownerId: nil,
...
public extension DisableImageBlockPublicAccessRequest {
    /**
     Default instance of the DisableImageBlockPublicAccessRequest structure.
     */
    static let __default: ElasticComputeCloudModel.DisableImageBlockPublicAccessRequest = {
...
public extension DisableImageBlockPublicAccessResult {
    /**
     Default instance of the DisableImageBlockPublicAccessResult structure.
     */
    static let __default: ElasticComputeCloudModel.DisableImageBlockPublicAccessResult = {
        let defaultInstance = ElasticComputeCloudModel.DisableImageBlockPublicAccessResult(
            imageBlockPublicAccessState: nil)
...
public extension DisableImageRequest {
    /**
     Default instance of the DisableImageRequest structure.
     */
    static let __default: ElasticComputeCloudModel.DisableImageRequest = {
...
public extension DisableImageResult {
    /**
     Default instance of the DisableImageResult structure.
     */
    static let __default: ElasticComputeCloudModel.DisableImageResult = {
        let defaultInstance = ElasticComputeCloudModel.DisableImageResult(
            return: nil)
...
public extension DisableIpamOrganizationAdminAccountRequest {
    /**
     Default instance of the DisableIpamOrganizationAdminAccountRequest structure.
     */
    static let __default: ElasticComputeCloudModel.DisableIpamOrganizationAdminAccountRequest = {
        let defaultInstance = ElasticComputeCloudModel.DisableIpamOrganizationAdminAccountRequest(
            delegatedAdminAccountId: "value",
            dryRun: nil)
...
public extension DisableIpamOrganizationAdminAccountResult {
    /**
     Default instance of the DisableIpamOrganizationAdminAccountResult structure.
     */
    static let __default: ElasticComputeCloudModel.DisableIpamOrganizationAdminAccountResult = {
        let defaultInstance = ElasticComputeCloudModel.DisableIpamOrganizationAdminAccountResult(
            success: nil)
...
public extension DisableTransitGatewayRouteTablePropagationRequest {
    ...
    static let __default: ElasticComputeCloudModel.DisableTransitGatewayRouteTablePropagationRequest = {
        let defaultInstance = ElasticComputeCloudModel.DisableTransitGatewayRouteTablePropagationRequest(
            dryRun: nil,
            transitGatewayAttachmentId: nil,
            transitGatewayRouteTableAnnouncementId: nil,
            transitGatewayRouteTableId: "value")
...
public extension DisassociateEnclaveCertificateIamRoleRequest {
    /**
     Default instance of the DisassociateEnclaveCertificateIamRoleRequest structure.
     */
...
public extension DisassociateEnclaveCertificateIamRoleResult {
    /**
     Default instance of the DisassociateEnclaveCertificateIamRoleResult structure.
     */
    static let __default: ElasticComputeCloudModel.DisassociateEnclaveCertificateIamRoleResult = {
        let defaultInstance = ElasticComputeCloudModel.DisassociateEnclaveCertificateIamRoleResult(
            return: nil)
...
public extension DisassociateInstanceEventWindowRequest {
    /**
     Default instance of the DisassociateInstanceEventWindowRequest structure.
     */
    static let __default: ElasticComputeCloudModel.DisassociateInstanceEventWindowRequest = {
        let defaultInstance = ElasticComputeCloudModel.DisassociateInstanceEventWindowRequest(
            associationTarget: InstanceEventWindowDisassociationRequest.__default,
            dryRun: nil,
            instanceEventWindowId: "value")
...
public extension DisassociateInstanceEventWindowResult {
    /**
     Default instance of the DisassociateInstanceEventWindowResult structure.
     */
    static let __default: ElasticComputeCloudModel.DisassociateInstanceEventWindowResult = {
        let defaultInstance = ElasticComputeCloudModel.DisassociateInstanceEventWindowResult(
            instanceEventWindow: nil)
...
public extension DisassociateIpamResourceDiscoveryRequest {
    /**
     Default instance of the DisassociateIpamResourceDiscoveryRequest structure.
     */
    static let __default: ElasticComputeCloudModel.DisassociateIpamResourceDiscoveryRequest = {
        let defaultInstance = ElasticComputeCloudModel.DisassociateIpamResourceDiscoveryRequest(
            dryRun: nil,
            ipamResourceDiscoveryAssociationId: "value")

        return defaultInstance
    }()
}

public extension DisassociateIpamResourceDiscoveryResult {
    /**
     Default instance of the DisassociateIpamResourceDiscoveryResult structure.
     */
    static let __default: ElasticComputeCloudModel.DisassociateIpamResourceDiscoveryResult = {
        let defaultInstance = ElasticComputeCloudModel.DisassociateIpamResourceDiscoveryResult(
            ipamResourceDiscoveryAssociation: nil)
...
public extension DisassociateNatGatewayAddressRequest {
    /**
     Default instance of the DisassociateNatGatewayAddressRequest structure.
     */
    static let __default: ElasticComputeCloudModel.DisassociateNatGatewayAddressRequest = {
        let defaultInstance = ElasticComputeCloudModel.DisassociateNatGatewayAddressRequest(
            associationIds: [],
            dryRun: nil,
            maxDrainDurationSeconds: nil,
            natGatewayId: "value")
...
public extension DisassociateNatGatewayAddressResult {
    /**
     Default instance of the DisassociateNatGatewayAddressResult structure.
     */
    static let __default: ElasticComputeCloudModel.DisassociateNatGatewayAddressResult = {
        let defaultInstance = ElasticComputeCloudModel.DisassociateNatGatewayAddressResult(
            natGatewayAddresses: nil,
            natGatewayId: nil)
...
public extension DisassociateTransitGatewayPolicyTableRequest {
    /**
     Default instance of the DisassociateTransitGatewayPolicyTableRequest structure.
     */
    static let __default: ElasticComputeCloudModel.DisassociateTransitGatewayPolicyTableRequest = {
        let defaultInstance = ElasticComputeCloudModel.DisassociateTransitGatewayPolicyTableRequest(
            dryRun: nil,
            transitGatewayAttachmentId: "value",
            transitGatewayPolicyTableId: "value")
...
public extension DisassociateTransitGatewayPolicyTableResult {
    /**
     Default instance of the DisassociateTransitGatewayPolicyTableResult structure.
     */
    static let __default: ElasticComputeCloudModel.DisassociateTransitGatewayPolicyTableResult = {
        let defaultInstance = ElasticComputeCloudModel.DisassociateTransitGatewayPolicyTableResult(
            association: nil)
...
public extension DnsOptions {
    /**
     Default instance of the DnsOptions structure.
     */
    static let __default: ElasticComputeCloudModel.DnsOptions = {
        let defaultInstance = ElasticComputeCloudModel.DnsOptions(
            dnsRecordIpType: nil,
            privateDnsOnlyForInboundResolverEndpoint: nil)

        return defaultInstance
    }()
}

public extension DnsOptionsSpecification {
    /**
     Default instance of the DnsOptionsSpecification structure.
     */
    static let __default: ElasticComputeCloudModel.DnsOptionsSpecification = {
        let defaultInstance = ElasticComputeCloudModel.DnsOptionsSpecification(
            dnsRecordIpType: nil,
            privateDnsOnlyForInboundResolverEndpoint: nil)
...
public extension Ec2InstanceConnectEndpoint {
    /**
     Default instance of the Ec2InstanceConnectEndpoint structure.
     */
    static let __default: ElasticComputeCloudModel.Ec2InstanceConnectEndpoint = {
        let defaultInstance = ElasticComputeCloudModel.Ec2InstanceConnectEndpoint(
            availabilityZone: nil,
            createdAt: nil,
            dnsName: nil,
            fipsDnsName: nil,
            instanceConnectEndpointArn: nil,
            instanceConnectEndpointId: nil,
            networkInterfaceIds: nil,
            ownerId: nil,
            preserveClientIp: nil,
            securityGroupIds: nil,
...
public extension EnableFastLaunchRequest {
    /**
     Default instance of the EnableFastLaunchRequest structure.
     */
    static let __default: ElasticComputeCloudModel.EnableFastLaunchRequest = {
        let defaultInstance = ElasticComputeCloudModel.EnableFastLaunchRequest(
            dryRun: nil,
            imageId: "value",
            launchTemplate: nil,
            maxParallelLaunches: nil,
...
public extension EnableFastLaunchResult {
    /**
     Default instance of the EnableFastLaunchResult structure.
     */
    static let __default: ElasticComputeCloudModel.EnableFastLaunchResult = {
        let defaultInstance = ElasticComputeCloudModel.EnableFastLaunchResult(
            imageId: nil,
            launchTemplate: nil,
            maxParallelLaunches: nil,
            ownerId: nil,
...
public extension EnableImageBlockPublicAccessRequest {
    /**
     Default instance of the EnableImageBlockPublicAccessRequest structure.
     */
    static let __default: ElasticComputeCloudModel.EnableImageBlockPublicAccessRequest = {
        let defaultInstance = ElasticComputeCloudModel.EnableImageBlockPublicAccessRequest(
            dryRun: nil,
            imageBlockPublicAccessState: .__default)

        return defaultInstance
    }()
}

public extension EnableImageBlockPublicAccessResult {
    /**
     Default instance of the EnableImageBlockPublicAccessResult structure.
     */
    static let __default: ElasticComputeCloudModel.EnableImageBlockPublicAccessResult = {
        let defaultInstance = ElasticComputeCloudModel.EnableImageBlockPublicAccessResult(
            imageBlockPublicAccessState: nil)
...
public extension EnableImageRequest {
    /**
     Default instance of the EnableImageRequest structure.
     */
    static let __default: ElasticComputeCloudModel.EnableImageRequest = {
        let defaultInstance = ElasticComputeCloudModel.EnableImageRequest(
            dryRun: nil,
            imageId: "value")
...
public extension EnableImageResult {
    /**
     Default instance of the EnableImageResult structure.
     */
    static let __default: ElasticComputeCloudModel.EnableImageResult = {
        let defaultInstance = ElasticComputeCloudModel.EnableImageResult(
            return: nil)
...
public extension EnableIpamOrganizationAdminAccountRequest {
    /**
     Default instance of the EnableIpamOrganizationAdminAccountRequest structure.
     */
    static let __default: ElasticComputeCloudModel.EnableIpamOrganizationAdminAccountRequest = {
        let defaultInstance = ElasticComputeCloudModel.EnableIpamOrganizationAdminAccountRequest(
            delegatedAdminAccountId: "value",
            dryRun: nil)
...
public extension EnableIpamOrganizationAdminAccountResult {
    /**
     Default instance of the EnableIpamOrganizationAdminAccountResult structure.
     */
...
public extension EnclaveOptions {
    /**
     Default instance of the EnclaveOptions structure.
     */
    static let __default: ElasticComputeCloudModel.EnclaveOptions = {
        let defaultInstance = ElasticComputeCloudModel.EnclaveOptions(
            enabled: nil)
...
public extension EnclaveOptionsRequest {
    /**
     Default instance of the EnclaveOptionsRequest structure.
     */
    static let __default: ElasticComputeCloudModel.EnclaveOptionsRequest = {
        let defaultInstance = ElasticComputeCloudModel.EnclaveOptionsRequest(
            enabled: nil)
...
public extension Explanation {
    /**
     Default instance of the Explanation structure.
     */
    static let __default: ElasticComputeCloudModel.Explanation = {
        let defaultInstance = ElasticComputeCloudModel.Explanation(
            acl: nil,
            aclRule: nil,
            address: nil,
            addresses: nil,
            ...
            availabilityZones: nil,
            cidrs: nil,
            classicLoadBalancerListener: nil,
            component: nil,
            componentAccount: nil,
            componentRegion: nil,
            customerGateway: nil,
            destination: nil,
            destinationVpc: nil,
            direction: nil,
            elasticLoadBalancerListener: nil,
            explanationCode: nil,
            firewallStatefulRule: nil,
            firewallStatelessRule: nil,
            ingressRouteTable: nil,
            internetGateway: nil,
            loadBalancerArn: nil,
            loadBalancerListenerPort: nil,
            loadBalancerTarget: nil,
            loadBalancerTargetGroup: nil,
            loadBalancerTargetGroups: nil,
            loadBalancerTargetPort: nil,
            missingComponent: nil,
            natGateway: nil,
            networkInterface: nil,
            packetField: nil,
            port: nil,
            ...
            transitGatewayRouteTable: nil,
            transitGatewayRouteTableRoute: nil,
            vpc: nil,
            vpcEndpoint: nil,
            vpcPeeringConnection: nil,
            vpnConnection: nil,
...
public extension FastLaunchLaunchTemplateSpecificationRequest {
    /**
     Default instance of the FastLaunchLaunchTemplateSpecificationRequest structure.
     */
    static let __default: ElasticComputeCloudModel.FastLaunchLaunchTemplateSpecificationRequest = {
        let defaultInstance = ElasticComputeCloudModel.FastLaunchLaunchTemplateSpecificationRequest(
            launchTemplateId: nil,
            launchTemplateName: nil,
            version: "value")
...
public extension FastLaunchLaunchTemplateSpecificationResponse {
    /**
     Default instance of the FastLaunchLaunchTemplateSpecificationResponse structure.
     */
    static let __default: ElasticComputeCloudModel.FastLaunchLaunchTemplateSpecificationResponse = {
        let defaultInstance = ElasticComputeCloudModel.FastLaunchLaunchTemplateSpecificationResponse(
            launchTemplateId: nil,
            launchTemplateName: nil,
            version: nil)
...
public extension FastLaunchSnapshotConfigurationRequest {
    /**
     Default instance of the FastLaunchSnapshotConfigurationRequest structure.
     */
    static let __default: ElasticComputeCloudModel.FastLaunchSnapshotConfigurationRequest = {
        let defaultInstance = ElasticComputeCloudModel.FastLaunchSnapshotConfigurationRequest(
            targetResourceCount: nil)

        return defaultInstance
    }()
}

public extension FastLaunchSnapshotConfigurationResponse {
    /**
     Default instance of the FastLaunchSnapshotConfigurationResponse structure.
     */
    static let __default: ElasticComputeCloudModel.FastLaunchSnapshotConfigurationResponse = {
        let defaultInstance = ElasticComputeCloudModel.FastLaunchSnapshotConfigurationResponse(
            targetResourceCount: nil)
...
public extension FederatedAuthentication {
    ...
    static let __default: ElasticComputeCloudModel.FederatedAuthentication = {
        let defaultInstance = ElasticComputeCloudModel.FederatedAuthentication(
            samlProviderArn: nil,
            selfServiceSamlProviderArn: nil)
...
public extension FilterPortRange {
    /**
     Default instance of the FilterPortRange structure.
     */
    static let __default: ElasticComputeCloudModel.FilterPortRange = {
        let defaultInstance = ElasticComputeCloudModel.FilterPortRange(
            fromPort: nil,
            toPort: nil)
...
public extension FirewallStatefulRule {
    /**
     Default instance of the FirewallStatefulRule structure.
     */
    static let __default: ElasticComputeCloudModel.FirewallStatefulRule = {
        let defaultInstance = ElasticComputeCloudModel.FirewallStatefulRule(
...
public extension FirewallStatelessRule {
    /**
     Default instance of the FirewallStatelessRule structure.
     */
    static let __default: ElasticComputeCloudModel.FirewallStatelessRule = {
        let defaultInstance = ElasticComputeCloudModel.FirewallStatelessRule(
            destinationPorts: nil,
            destinations: nil,
            priority: nil,
            protocols: nil,
...
public extension FleetSpotCapacityRebalance {
    /**
     Default instance of the FleetSpotCapacityRebalance structure.
     */
...
public extension FleetSpotCapacityRebalanceRequest {
    /**
     Default instance of the FleetSpotCapacityRebalanceRequest structure.
     */
...
public extension FleetSpotMaintenanceStrategies {
    /**
     Default instance of the FleetSpotMaintenanceStrategies structure.
     */
    static let __default: ElasticComputeCloudModel.FleetSpotMaintenanceStrategies = {
        let defaultInstance = ElasticComputeCloudModel.FleetSpotMaintenanceStrategies(
            capacityRebalance: nil)

        return defaultInstance
    }()
}

public extension FleetSpotMaintenanceStrategiesRequest {
    /**
     Default instance of the FleetSpotMaintenanceStrategiesRequest structure.
     */
    static let __default: ElasticComputeCloudModel.FleetSpotMaintenanceStrategiesRequest = {
        let defaultInstance = ElasticComputeCloudModel.FleetSpotMaintenanceStrategiesRequest(
            capacityRebalance: nil)
...
public extension GetAssociatedEnclaveCertificateIamRolesRequest {
    /**
     Default instance of the GetAssociatedEnclaveCertificateIamRolesRequest structure.
     */
    static let __default: ElasticComputeCloudModel.GetAssociatedEnclaveCertificateIamRolesRequest = {
...
public extension GetAssociatedEnclaveCertificateIamRolesResult {
    /**
     Default instance of the GetAssociatedEnclaveCertificateIamRolesResult structure.
     */
    static let __default: ElasticComputeCloudModel.GetAssociatedEnclaveCertificateIamRolesResult = {
        let defaultInstance = ElasticComputeCloudModel.GetAssociatedEnclaveCertificateIamRolesResult(
            associatedRoles: nil)
...
public extension GetImageBlockPublicAccessStateRequest {
    /**
     Default instance of the GetImageBlockPublicAccessStateRequest structure.
     */
    static let __default: ElasticComputeCloudModel.GetImageBlockPublicAccessStateRequest = {
        let defaultInstance = ElasticComputeCloudModel.GetImageBlockPublicAccessStateRequest(
            dryRun: nil)
...
public extension GetImageBlockPublicAccessStateResult {
    /**
     Default instance of the GetImageBlockPublicAccessStateResult structure.
     */
    static let __default: ElasticComputeCloudModel.GetImageBlockPublicAccessStateResult = {
        let defaultInstance = ElasticComputeCloudModel.GetImageBlockPublicAccessStateResult(
            imageBlockPublicAccessState: nil)
...
public extension GetInstanceUefiDataRequest {
    /**
     Default instance of the GetInstanceUefiDataRequest structure.
     */
    static let __default: ElasticComputeCloudModel.GetInstanceUefiDataRequest = {
        let defaultInstance = ElasticComputeCloudModel.GetInstanceUefiDataRequest(
            dryRun: nil,
            instanceId: "value")
...
public extension GetInstanceUefiDataResult {
    /**
     Default instance of the GetInstanceUefiDataResult structure.
     */
    static let __default: ElasticComputeCloudModel.GetInstanceUefiDataResult = {
        let defaultInstance = ElasticComputeCloudModel.GetInstanceUefiDataResult(
            instanceId: nil,
            uefiData: nil)
...
public extension GetIpamAddressHistoryRequest {
    /**
     Default instance of the GetIpamAddressHistoryRequest structure.
     */
    static let __default: ElasticComputeCloudModel.GetIpamAddressHistoryRequest = {
        let defaultInstance = ElasticComputeCloudModel.GetIpamAddressHistoryRequest(
            cidr: "value",
            dryRun: nil,
            endTime: nil,
            ipamScopeId: "value",
...
public extension GetIpamAddressHistoryResult {
    /**
     Default instance of the GetIpamAddressHistoryResult structure.
     */
    static let __default: ElasticComputeCloudModel.GetIpamAddressHistoryResult = {
        let defaultInstance = ElasticComputeCloudModel.GetIpamAddressHistoryResult(
            historyRecords: nil,
            nextToken: nil)
...
public extension GetIpamDiscoveredAccountsRequest {
    /**
     Default instance of the GetIpamDiscoveredAccountsRequest structure.
     */
    static let __default: ElasticComputeCloudModel.GetIpamDiscoveredAccountsRequest = {
        let defaultInstance = ElasticComputeCloudModel.GetIpamDiscoveredAccountsRequest(
...
public extension GetIpamDiscoveredAccountsResult {
    /**
     Default instance of the GetIpamDiscoveredAccountsResult structure.
     */
    static let __default: ElasticComputeCloudModel.GetIpamDiscoveredAccountsResult = {
        let defaultInstance = ElasticComputeCloudModel.GetIpamDiscoveredAccountsResult(
            ipamDiscoveredAccounts: nil,
            nextToken: nil)
...
public extension GetIpamDiscoveredResourceCidrsRequest {
    /**
     Default instance of the GetIpamDiscoveredResourceCidrsRequest structure.
     */
    static let __default: ElasticComputeCloudModel.GetIpamDiscoveredResourceCidrsRequest = {
        let defaultInstance = ElasticComputeCloudModel.GetIpamDiscoveredResourceCidrsRequest(
            dryRun: nil,
            filters: nil,
            ipamResourceDiscoveryId: "value",
            maxResults: nil,
...
public extension GetIpamDiscoveredResourceCidrsResult {
    /**
     Default instance of the GetIpamDiscoveredResourceCidrsResult structure.
     */
    static let __default: ElasticComputeCloudModel.GetIpamDiscoveredResourceCidrsResult = {
        let defaultInstance = ElasticComputeCloudModel.GetIpamDiscoveredResourceCidrsResult(
            ipamDiscoveredResourceCidrs: nil,
            nextToken: nil)
...
public extension GetIpamPoolAllocationsRequest {
    /**
     Default instance of the GetIpamPoolAllocationsRequest structure.
     */
    static let __default: ElasticComputeCloudModel.GetIpamPoolAllocationsRequest = {
        let defaultInstance = ElasticComputeCloudModel.GetIpamPoolAllocationsRequest(
            dryRun: nil,
            filters: nil,
            ipamPoolAllocationId: nil,
            ipamPoolId: "value",
            maxResults: nil,
            nextToken: nil)
...
public extension GetIpamPoolAllocationsResult {
    /**
     Default instance of the GetIpamPoolAllocationsResult structure.
     */
    static let __default: ElasticComputeCloudModel.GetIpamPoolAllocationsResult = {
        let defaultInstance = ElasticComputeCloudModel.GetIpamPoolAllocationsResult(
...
public extension GetIpamPoolCidrsRequest {
    /**
     Default instance of the GetIpamPoolCidrsRequest structure.
     */
    static let __default: ElasticComputeCloudModel.GetIpamPoolCidrsRequest = {
        let defaultInstance = ElasticComputeCloudModel.GetIpamPoolCidrsRequest(
            dryRun: nil,
            filters: nil,
            ipamPoolId: "value",
            maxResults: nil,
...
public extension GetIpamPoolCidrsResult {
    /**
     Default instance of the GetIpamPoolCidrsResult structure.
     */
    static let __default: ElasticComputeCloudModel.GetIpamPoolCidrsResult = {
        let defaultInstance = ElasticComputeCloudModel.GetIpamPoolCidrsResult(
            ipamPoolCidrs: nil,
            nextToken: nil)
...
public extension GetIpamResourceCidrsRequest {
    /**
     Default instance of the GetIpamResourceCidrsRequest structure.
     */
    static let __default: ElasticComputeCloudModel.GetIpamResourceCidrsRequest = {
        let defaultInstance = ElasticComputeCloudModel.GetIpamResourceCidrsRequest(
            dryRun: nil,
            filters: nil,
            ipamPoolId: nil,
            ipamScopeId: "value",
...
public extension GetIpamResourceCidrsResult {
    /**
     Default instance of the GetIpamResourceCidrsResult structure.
     */
    static let __default: ElasticComputeCloudModel.GetIpamResourceCidrsResult = {
        let defaultInstance = ElasticComputeCloudModel.GetIpamResourceCidrsResult(
...
public extension GetNetworkInsightsAccessScopeAnalysisFindingsRequest {
    /**
     Default instance of the GetNetworkInsightsAccessScopeAnalysisFindingsRequest structure.
     */
    static let __default: ElasticComputeCloudModel.GetNetworkInsightsAccessScopeAnalysisFindingsRequest = {
        let defaultInstance = ElasticComputeCloudModel.GetNetworkInsightsAccessScopeAnalysisFindingsRequest(
            dryRun: nil,
            maxResults: nil,
            networkInsightsAccessScopeAnalysisId: "value",
            nextToken: nil)
...
public extension GetNetworkInsightsAccessScopeAnalysisFindingsResult {
    /**
     Default instance of the GetNetworkInsightsAccessScopeAnalysisFindingsResult structure.
     */
    static let __default: ElasticComputeCloudModel.GetNetworkInsightsAccessScopeAnalysisFindingsResult = {
        let defaultInstance = ElasticComputeCloudModel.GetNetworkInsightsAccessScopeAnalysisFindingsResult(
...
public extension GetNetworkInsightsAccessScopeContentRequest {
    /**
     Default instance of the GetNetworkInsightsAccessScopeContentRequest structure.
     */
    static let __default: ElasticComputeCloudModel.GetNetworkInsightsAccessScopeContentRequest = {
        let defaultInstance = ElasticComputeCloudModel.GetNetworkInsightsAccessScopeContentRequest(
            dryRun: nil,
            networkInsightsAccessScopeId: "value")
...
public extension GetNetworkInsightsAccessScopeContentResult {
    /**
     Default instance of the GetNetworkInsightsAccessScopeContentResult structure.
     */
    static let __default: ElasticComputeCloudModel.GetNetworkInsightsAccessScopeContentResult = {
        let defaultInstance = ElasticComputeCloudModel.GetNetworkInsightsAccessScopeContentResult(
            networkInsightsAccessScopeContent: nil)
...
public extension GetSecurityGroupsForVpcRequest {
    /**
     Default instance of the GetSecurityGroupsForVpcRequest structure.
     */
    static let __default: ElasticComputeCloudModel.GetSecurityGroupsForVpcRequest = {
        let defaultInstance = ElasticComputeCloudModel.GetSecurityGroupsForVpcRequest(
            dryRun: nil,
            filters: nil,
            maxResults: nil,
            nextToken: nil,
...
public extension GetSecurityGroupsForVpcResult {
    /**
     Default instance of the GetSecurityGroupsForVpcResult structure.
     */
    static let __default: ElasticComputeCloudModel.GetSecurityGroupsForVpcResult = {
        let defaultInstance = ElasticComputeCloudModel.GetSecurityGroupsForVpcResult(
            nextToken: nil,
            securityGroupForVpcs: nil)
...
public extension GetSubnetCidrReservationsRequest {
    /**
     Default instance of the GetSubnetCidrReservationsRequest structure.
     */
    static let __default: ElasticComputeCloudModel.GetSubnetCidrReservationsRequest = {
        let defaultInstance = ElasticComputeCloudModel.GetSubnetCidrReservationsRequest(
            dryRun: nil,
            filters: nil,
            maxResults: nil,
            nextToken: nil,
...
public extension GetSubnetCidrReservationsResult {
    /**
     Default instance of the GetSubnetCidrReservationsResult structure.
     */
    static let __default: ElasticComputeCloudModel.GetSubnetCidrReservationsResult = {
        let defaultInstance = ElasticComputeCloudModel.GetSubnetCidrReservationsResult(
            nextToken: nil,
...
public extension GetTransitGatewayPolicyTableAssociationsRequest {
    /**
     Default instance of the GetTransitGatewayPolicyTableAssociationsRequest structure.
     */
    static let __default: ElasticComputeCloudModel.GetTransitGatewayPolicyTableAssociationsRequest = {
        let defaultInstance = ElasticComputeCloudModel.GetTransitGatewayPolicyTableAssociationsRequest(
            dryRun: nil,
            filters: nil,
            maxResults: nil,
            nextToken: nil,
...
public extension GetTransitGatewayPolicyTableAssociationsResult {
    /**
     Default instance of the GetTransitGatewayPolicyTableAssociationsResult structure.
     */
    static let __default: ElasticComputeCloudModel.GetTransitGatewayPolicyTableAssociationsResult = {
        let defaultInstance = ElasticComputeCloudModel.GetTransitGatewayPolicyTableAssociationsResult(
            associations: nil,
            nextToken: nil)
...
public extension GetTransitGatewayPolicyTableEntriesRequest {
    /**
     Default instance of the GetTransitGatewayPolicyTableEntriesRequest structure.
     */
    static let __default: ElasticComputeCloudModel.GetTransitGatewayPolicyTableEntriesRequest = {
        let defaultInstance = ElasticComputeCloudModel.GetTransitGatewayPolicyTableEntriesRequest(
            dryRun: nil,
            filters: nil,
            maxResults: nil,
            nextToken: nil,
...
public extension GetTransitGatewayPolicyTableEntriesResult {
    /**
     Default instance of the GetTransitGatewayPolicyTableEntriesResult structure.
     */
    static let __default: ElasticComputeCloudModel.GetTransitGatewayPolicyTableEntriesResult = {
        let defaultInstance = ElasticComputeCloudModel.GetTransitGatewayPolicyTableEntriesResult(
...
public extension GetVpnTunnelReplacementStatusRequest {
    /**
     Default instance of the GetVpnTunnelReplacementStatusRequest structure.
     */
    static let __default: ElasticComputeCloudModel.GetVpnTunnelReplacementStatusRequest = {
...
public extension GetVpnTunnelReplacementStatusResult {
    /**
     Default instance of the GetVpnTunnelReplacementStatusResult structure.
     */
    static let __default: ElasticComputeCloudModel.GetVpnTunnelReplacementStatusResult = {
        let defaultInstance = ElasticComputeCloudModel.GetVpnTunnelReplacementStatusResult(
            customerGatewayId: nil,
            maintenanceDetails: nil,
            transitGatewayId: nil,
            vpnConnectionId: nil,
            vpnGatewayId: nil,
            vpnTunnelOutsideIpAddress: nil)
...
public extension ImageRecycleBinInfo {
    /**
     Default instance of the ImageRecycleBinInfo structure.
     */
    static let __default: ElasticComputeCloudModel.ImageRecycleBinInfo = {
        let defaultInstance = ElasticComputeCloudModel.ImageRecycleBinInfo(
            description: nil,
            imageId: nil,
            name: nil,
            recycleBinEnterTime: nil,
            recycleBinExitTime: nil)
...
public extension InstanceEventWindow {
    /**
     Default instance of the InstanceEventWindow structure.
     */
    static let __default: ElasticComputeCloudModel.InstanceEventWindow = {
        let defaultInstance = ElasticComputeCloudModel.InstanceEventWindow(
            associationTarget: nil,
            cronExpression: nil,
            instanceEventWindowId: nil,
            name: nil,
            state: nil,
            tags: nil,
            timeRanges: nil)
...
public extension InstanceEventWindowAssociationRequest {
    /**
     Default instance of the InstanceEventWindowAssociationRequest structure.
     */
    static let __default: ElasticComputeCloudModel.InstanceEventWindowAssociationRequest = {
        let defaultInstance = ElasticComputeCloudModel.InstanceEventWindowAssociationRequest(
...
public extension InstanceEventWindowAssociationTarget {
    /**
     Default instance of the InstanceEventWindowAssociationTarget structure.
     */
    static let __default: ElasticComputeCloudModel.InstanceEventWindowAssociationTarget = {
        let defaultInstance = ElasticComputeCloudModel.InstanceEventWindowAssociationTarget(
            dedicatedHostIds: nil,
            instanceIds: nil,
            tags: nil)
...
public extension InstanceEventWindowDisassociationRequest {
    /**
     Default instance of the InstanceEventWindowDisassociationRequest structure.
     */
    static let __default: ElasticComputeCloudModel.InstanceEventWindowDisassociationRequest = {
        let defaultInstance = ElasticComputeCloudModel.InstanceEventWindowDisassociationRequest(
            dedicatedHostIds: nil,
            instanceIds: nil,
            instanceTags: nil)
...
public extension InstanceEventWindowStateChange {
    /**
     Default instance of the InstanceEventWindowStateChange structure.
     */
    static let __default: ElasticComputeCloudModel.InstanceEventWindowStateChange = {
        let defaultInstance = ElasticComputeCloudModel.InstanceEventWindowStateChange(
            instanceEventWindowId: nil,
            state: nil)
...
public extension InstanceEventWindowTimeRange {
    /**
     Default instance of the InstanceEventWindowTimeRange structure.
     */
    static let __default: ElasticComputeCloudModel.InstanceEventWindowTimeRange = {
        let defaultInstance = ElasticComputeCloudModel.InstanceEventWindowTimeRange(
            endHour: nil,
            endWeekDay: nil,
            startHour: nil,
            startWeekDay: nil)
...
public extension InstanceEventWindowTimeRangeRequest {
    /**
     Default instance of the InstanceEventWindowTimeRangeRequest structure.
     */
    static let __default: ElasticComputeCloudModel.InstanceEventWindowTimeRangeRequest = {
        let defaultInstance = ElasticComputeCloudModel.InstanceEventWindowTimeRangeRequest(
            endHour: nil,
            endWeekDay: nil,
            startHour: nil,
            startWeekDay: nil)
...
public extension InstanceIpv4Prefix {
    /**
     Default instance of the InstanceIpv4Prefix structure.
     */
    static let __default: ElasticComputeCloudModel.InstanceIpv4Prefix = {
        let defaultInstance = ElasticComputeCloudModel.InstanceIpv4Prefix(
            ipv4Prefix: nil)
...
public extension InstanceIpv6Prefix {
    /**
     Default instance of the InstanceIpv6Prefix structure.
     */
    static let __default: ElasticComputeCloudModel.InstanceIpv6Prefix = {
        let defaultInstance = ElasticComputeCloudModel.InstanceIpv6Prefix(
            ipv6Prefix: nil)
...
public extension InstanceMaintenanceOptions {
    /**
     Default instance of the InstanceMaintenanceOptions structure.
     */
    static let __default: ElasticComputeCloudModel.InstanceMaintenanceOptions = {
        let defaultInstance = ElasticComputeCloudModel.InstanceMaintenanceOptions(
            autoRecovery: nil)
...
public extension InstanceMaintenanceOptionsRequest {
    /**
     Default instance of the InstanceMaintenanceOptionsRequest structure.
     */
    static let __default: ElasticComputeCloudModel.InstanceMaintenanceOptionsRequest = {
        let defaultInstance = ElasticComputeCloudModel.InstanceMaintenanceOptionsRequest(
            autoRecovery: nil)
...
public extension Ipam {
    /**
     Default instance of the Ipam structure.
     */
    static let __default: ElasticComputeCloudModel.Ipam = {
        let defaultInstance = ElasticComputeCloudModel.Ipam(
            defaultResourceDiscoveryAssociationId: nil,
            defaultResourceDiscoveryId: nil,
            description: nil,
            ipamArn: nil,
            ipamId: nil,
            ipamRegion: nil,
            operatingRegions: nil,
            ownerId: nil,
            privateDefaultScopeId: nil,
            publicDefaultScopeId: nil,
            resourceDiscoveryAssociationCount: nil,
            scopeCount: nil,
            state: nil,
            tags: nil)
...
public extension IpamAddressHistoryRecord {
    /**
     Default instance of the IpamAddressHistoryRecord structure.
     */
    static let __default: ElasticComputeCloudModel.IpamAddressHistoryRecord = {
        let defaultInstance = ElasticComputeCloudModel.IpamAddressHistoryRecord(
            resourceCidr: nil,
            resourceComplianceStatus: nil,
            resourceId: nil,
            resourceName: nil,
            resourceOverlapStatus: nil,
            resourceOwnerId: nil,
            resourceRegion: nil,
            resourceType: nil,
            sampledEndTime: nil,
            sampledStartTime: nil,
            vpcId: nil)
...
public extension IpamCidrAuthorizationContext {
    /**
     Default instance of the IpamCidrAuthorizationContext structure.
     */
    static let __default: ElasticComputeCloudModel.IpamCidrAuthorizationContext = {
        let defaultInstance = ElasticComputeCloudModel.IpamCidrAuthorizationContext(
            message: nil,
            signature: nil)
...
public extension IpamDiscoveredAccount {
    /**
     Default instance of the IpamDiscoveredAccount structure.
     */
    static let __default: ElasticComputeCloudModel.IpamDiscoveredAccount = {
        let defaultInstance = ElasticComputeCloudModel.IpamDiscoveredAccount(
            accountId: nil,
            discoveryRegion: nil,
            failureReason: nil,
            lastAttemptedDiscoveryTime: nil,
            lastSuccessfulDiscoveryTime: nil)

        return defaultInstance
    }()
}

public extension IpamDiscoveredResourceCidr {
    /**
     Default instance of the IpamDiscoveredResourceCidr structure.
     */
    static let __default: ElasticComputeCloudModel.IpamDiscoveredResourceCidr = {
        let defaultInstance = ElasticComputeCloudModel.IpamDiscoveredResourceCidr(
            ipUsage: nil,
            ipamResourceDiscoveryId: nil,
            resourceCidr: nil,
            resourceId: nil,
            resourceOwnerId: nil,
            resourceRegion: nil,
...
public extension IpamDiscoveryFailureReason {
    /**
     Default instance of the IpamDiscoveryFailureReason structure.
     */
    static let __default: ElasticComputeCloudModel.IpamDiscoveryFailureReason = {
...
public extension IpamOperatingRegion {
    /**
     Default instance of the IpamOperatingRegion structure.
     */
    static let __default: ElasticComputeCloudModel.IpamOperatingRegion = {
        let defaultInstance = ElasticComputeCloudModel.IpamOperatingRegion(
            regionName: nil)
...
public extension IpamPool {
    /**
     Default instance of the IpamPool structure.
     */
    static let __default: ElasticComputeCloudModel.IpamPool = {
        let defaultInstance = ElasticComputeCloudModel.IpamPool(
            addressFamily: nil,
            allocationDefaultNetmaskLength: nil,
            allocationMaxNetmaskLength: nil,
            allocationMinNetmaskLength: nil,
...
public extension IpamPoolAllocation {
    /**
     Default instance of the IpamPoolAllocation structure.
     */
    static let __default: ElasticComputeCloudModel.IpamPoolAllocation = {
        let defaultInstance = ElasticComputeCloudModel.IpamPoolAllocation(
            cidr: nil,
            description: nil,
            ipamPoolAllocationId: nil,
            resourceId: nil,
...
public extension IpamPoolCidr {
    /**
     Default instance of the IpamPoolCidr structure.
     */
    static let __default: ElasticComputeCloudModel.IpamPoolCidr = {
        let defaultInstance = ElasticComputeCloudModel.IpamPoolCidr(
            cidr: nil,
            failureReason: nil,
            ipamPoolCidrId: nil,
            netmaskLength: nil,
...
public extension IpamPoolCidrFailureReason {
    /**
     Default instance of the IpamPoolCidrFailureReason structure.
     */
    static let __default: ElasticComputeCloudModel.IpamPoolCidrFailureReason = {
        let defaultInstance = ElasticComputeCloudModel.IpamPoolCidrFailureReason(
            code: nil,
            message: nil)
...
public extension IpamResourceCidr {
    /**
     Default instance of the IpamResourceCidr structure.
     */
    static let __default: ElasticComputeCloudModel.IpamResourceCidr = {
        let defaultInstance = ElasticComputeCloudModel.IpamResourceCidr(
...
public extension IpamResourceDiscovery {
    /**
     Default instance of the IpamResourceDiscovery structure.
     */
    static let __default: ElasticComputeCloudModel.IpamResourceDiscovery = {
        let defaultInstance = ElasticComputeCloudModel.IpamResourceDiscovery(
            description: nil,
            ipamResourceDiscoveryArn: nil,
            ipamResourceDiscoveryId: nil,
            ipamResourceDiscoveryRegion: nil,
            isDefault: nil,
            operatingRegions: nil,
            ownerId: nil,
            state: nil,
...
public extension IpamResourceDiscoveryAssociation {
    /**
     Default instance of the IpamResourceDiscoveryAssociation structure.
     */
    static let __default: ElasticComputeCloudModel.IpamResourceDiscoveryAssociation = {
        let defaultInstance = ElasticComputeCloudModel.IpamResourceDiscoveryAssociation(
            ipamArn: nil,
            ipamId: nil,
            ipamRegion: nil,
            ipamResourceDiscoveryAssociationArn: nil,
            ipamResourceDiscoveryAssociationId: nil,
            ipamResourceDiscoveryId: nil,
            isDefault: nil,
            ownerId: nil,
            resourceDiscoveryStatus: nil,
            state: nil,
            tags: nil)
...
public extension IpamResourceTag {
    /**
     Default instance of the IpamResourceTag structure.
     */
    static let __default: ElasticComputeCloudModel.IpamResourceTag = {
        let defaultInstance = ElasticComputeCloudModel.IpamResourceTag(
            key: nil,
            value: nil)
...
public extension IpamScope {
    /**
     Default instance of the IpamScope structure.
     */
    static let __default: ElasticComputeCloudModel.IpamScope = {
        let defaultInstance = ElasticComputeCloudModel.IpamScope(
            description: nil,
            ipamArn: nil,
            ipamRegion: nil,
            ipamScopeArn: nil,
...
public extension Ipv4PrefixSpecification {
    /**
     Default instance of the Ipv4PrefixSpecification structure.
     */
    static let __default: ElasticComputeCloudModel.Ipv4PrefixSpecification = {
        let defaultInstance = ElasticComputeCloudModel.Ipv4PrefixSpecification(
            ipv4Prefix: nil)
...
public extension Ipv4PrefixSpecificationRequest {
    /**
     Default instance of the Ipv4PrefixSpecificationRequest structure.
     */
    static let __default: ElasticComputeCloudModel.Ipv4PrefixSpecificationRequest = {
        let defaultInstance = ElasticComputeCloudModel.Ipv4PrefixSpecificationRequest(
            ipv4Prefix: nil)
...
public extension Ipv4PrefixSpecificationResponse {
    /**
     Default instance of the Ipv4PrefixSpecificationResponse structure.
     */
    static let __default: ElasticComputeCloudModel.Ipv4PrefixSpecificationResponse = {
        let defaultInstance = ElasticComputeCloudModel.Ipv4PrefixSpecificationResponse(
            ipv4Prefix: nil)
...
public extension Ipv6PrefixSpecification {
    /**
     Default instance of the Ipv6PrefixSpecification structure.
     */
    static let __default: ElasticComputeCloudModel.Ipv6PrefixSpecification = {
        let defaultInstance = ElasticComputeCloudModel.Ipv6PrefixSpecification(
            ipv6Prefix: nil)
...
public extension Ipv6PrefixSpecificationRequest {
    /**
     Default instance of the Ipv6PrefixSpecificationRequest structure.
     */
    static let __default: ElasticComputeCloudModel.Ipv6PrefixSpecificationRequest = {
        let defaultInstance = ElasticComputeCloudModel.Ipv6PrefixSpecificationRequest(
            ipv6Prefix: nil)
...
public extension Ipv6PrefixSpecificationResponse {
    /**
     Default instance of the Ipv6PrefixSpecificationResponse structure.
     */
    static let __default: ElasticComputeCloudModel.Ipv6PrefixSpecificationResponse = {
        let defaultInstance = ElasticComputeCloudModel.Ipv6PrefixSpecificationResponse(
            ipv6Prefix: nil)
...
public extension LaunchTemplateEnclaveOptions {
    /**
     Default instance of the LaunchTemplateEnclaveOptions structure.
     */
    static let __default: ElasticComputeCloudModel.LaunchTemplateEnclaveOptions = {
        let defaultInstance = ElasticComputeCloudModel.LaunchTemplateEnclaveOptions(
            enabled: nil)
...
public extension LaunchTemplateEnclaveOptionsRequest {
    /**
     Default instance of the LaunchTemplateEnclaveOptionsRequest structure.
     */
    static let __default: ElasticComputeCloudModel.LaunchTemplateEnclaveOptionsRequest = {
        let defaultInstance = ElasticComputeCloudModel.LaunchTemplateEnclaveOptionsRequest(
            enabled: nil)
...
public extension LaunchTemplateInstanceMaintenanceOptions {
    /**
     Default instance of the LaunchTemplateInstanceMaintenanceOptions structure.
     */
    static let __default: ElasticComputeCloudModel.LaunchTemplateInstanceMaintenanceOptions = {
        let defaultInstance = ElasticComputeCloudModel.LaunchTemplateInstanceMaintenanceOptions(
            autoRecovery: nil)
...
public extension LaunchTemplateInstanceMaintenanceOptionsRequest {
    /**
     Default instance of the LaunchTemplateInstanceMaintenanceOptionsRequest structure.
     */
    static let __default: ElasticComputeCloudModel.LaunchTemplateInstanceMaintenanceOptionsRequest = {
        let defaultInstance = ElasticComputeCloudModel.LaunchTemplateInstanceMaintenanceOptionsRequest(
            autoRecovery: nil)
...
public extension ListImagesInRecycleBinRequest {
    /**
     Default instance of the ListImagesInRecycleBinRequest structure.
     */
    static let __default: ElasticComputeCloudModel.ListImagesInRecycleBinRequest = {
        let defaultInstance = ElasticComputeCloudModel.ListImagesInRecycleBinRequest(
            dryRun: nil,
            imageIds: nil,
            maxResults: nil,
            nextToken: nil)
...
public extension ListImagesInRecycleBinResult {
    /**
     Default instance of the ListImagesInRecycleBinResult structure.
     */
    static let __default: ElasticComputeCloudModel.ListImagesInRecycleBinResult = {
        let defaultInstance = ElasticComputeCloudModel.ListImagesInRecycleBinResult(
            images: nil,
            nextToken: nil)
...
public extension ListSnapshotsInRecycleBinRequest {
    /**
     Default instance of the ListSnapshotsInRecycleBinRequest structure.
     */
    static let __default: ElasticComputeCloudModel.ListSnapshotsInRecycleBinRequest = {
        let defaultInstance = ElasticComputeCloudModel.ListSnapshotsInRecycleBinRequest(
            dryRun: nil,
            maxResults: nil,
            nextToken: nil,
            snapshotIds: nil)
...
public extension ListSnapshotsInRecycleBinResult {
    /**
     Default instance of the ListSnapshotsInRecycleBinResult structure.
     */
    static let __default: ElasticComputeCloudModel.ListSnapshotsInRecycleBinResult = {
        let defaultInstance = ElasticComputeCloudModel.ListSnapshotsInRecycleBinResult(
            nextToken: nil,
            snapshots: nil)
...
public extension MaintenanceDetails {
    /**
     Default instance of the MaintenanceDetails structure.
     */
    static let __default: ElasticComputeCloudModel.MaintenanceDetails = {
        let defaultInstance = ElasticComputeCloudModel.MaintenanceDetails(
            lastMaintenanceApplied: nil,
            maintenanceAutoAppliedAfter: nil,
...
public extension ModifyInstanceEventWindowRequest {
    /**
     Default instance of the ModifyInstanceEventWindowRequest structure.
     */
    static let __default: ElasticComputeCloudModel.ModifyInstanceEventWindowRequest = {
        let defaultInstance = ElasticComputeCloudModel.ModifyInstanceEventWindowRequest(
            cronExpression: nil,
            dryRun: nil,
            instanceEventWindowId: "value",
            name: nil,
...
public extension ModifyInstanceEventWindowResult {
    /**
     Default instance of the ModifyInstanceEventWindowResult structure.
     */
    static let __default: ElasticComputeCloudModel.ModifyInstanceEventWindowResult = {
        let defaultInstance = ElasticComputeCloudModel.ModifyInstanceEventWindowResult(
            instanceEventWindow: nil)
...
public extension ModifyInstanceMaintenanceOptionsRequest {
    /**
     Default instance of the ModifyInstanceMaintenanceOptionsRequest structure.
     */
    static let __default: ElasticComputeCloudModel.ModifyInstanceMaintenanceOptionsRequest = {
        let defaultInstance = ElasticComputeCloudModel.ModifyInstanceMaintenanceOptionsRequest(
            autoRecovery: nil,
            dryRun: nil,
            instanceId: "value")
...
public extension ModifyInstanceMaintenanceOptionsResult {
    /**
     Default instance of the ModifyInstanceMaintenanceOptionsResult structure.
     */
    static let __default: ElasticComputeCloudModel.ModifyInstanceMaintenanceOptionsResult = {
        let defaultInstance = ElasticComputeCloudModel.ModifyInstanceMaintenanceOptionsResult(
            autoRecovery: nil,
            instanceId: nil)
...
public extension ModifyIpamPoolRequest {
    /**
     Default instance of the ModifyIpamPoolRequest structure.
     */
    static let __default: ElasticComputeCloudModel.ModifyIpamPoolRequest = {
        let defaultInstance = ElasticComputeCloudModel.ModifyIpamPoolRequest(
...
public extension ModifyIpamPoolResult {
    /**
     Default instance of the ModifyIpamPoolResult structure.
     */
    static let __default: ElasticComputeCloudModel.ModifyIpamPoolResult = {
        let defaultInstance = ElasticComputeCloudModel.ModifyIpamPoolResult(
            ipamPool: nil)
...
public extension ModifyIpamRequest {
    /**
     Default instance of the ModifyIpamRequest structure.
     */
    static let __default: ElasticComputeCloudModel.ModifyIpamRequest = {
        let defaultInstance = ElasticComputeCloudModel.ModifyIpamRequest(
...
public extension ModifyIpamResourceCidrRequest {
    /**
     Default instance of the ModifyIpamResourceCidrRequest structure.
     */
    static let __default: ElasticComputeCloudModel.ModifyIpamResourceCidrRequest = {
        let defaultInstance = ElasticComputeCloudModel.ModifyIpamResourceCidrRequest(
            currentIpamScopeId: "value",
            destinationIpamScopeId: nil,
            dryRun: nil,
            monitored: false,
            resourceCidr: "value",
            resourceId: "value",
...
public extension ModifyIpamResourceCidrResult {
    /**
     Default instance of the ModifyIpamResourceCidrResult structure.
     */
    static let __default: ElasticComputeCloudModel.ModifyIpamResourceCidrResult = {
        let defaultInstance = ElasticComputeCloudModel.ModifyIpamResourceCidrResult(
            ipamResourceCidr: nil)

        return defaultInstance
    }()
}

public extension ModifyIpamResourceDiscoveryRequest {
    /**
     Default instance of the ModifyIpamResourceDiscoveryRequest structure.
     */
    static let __default: ElasticComputeCloudModel.ModifyIpamResourceDiscoveryRequest = {
        let defaultInstance = ElasticComputeCloudModel.ModifyIpamResourceDiscoveryRequest(
            addOperatingRegions: nil,
            description: nil,
            dryRun: nil,
            ipamResourceDiscoveryId: "value",
...
public extension ModifyIpamResourceDiscoveryResult {
    /**
     Default instance of the ModifyIpamResourceDiscoveryResult structure.
     */
    static let __default: ElasticComputeCloudModel.ModifyIpamResourceDiscoveryResult = {
        let defaultInstance = ElasticComputeCloudModel.ModifyIpamResourceDiscoveryResult(
            ipamResourceDiscovery: nil)
...
public extension ModifyIpamResult {
    /**
     Default instance of the ModifyIpamResult structure.
     */
    static let __default: ElasticComputeCloudModel.ModifyIpamResult = {
        let defaultInstance = ElasticComputeCloudModel.ModifyIpamResult(
            ipam: nil)
...
public extension ModifyIpamScopeRequest {
    /**
     Default instance of the ModifyIpamScopeRequest structure.
     */
    static let __default: ElasticComputeCloudModel.ModifyIpamScopeRequest = {
        let defaultInstance = ElasticComputeCloudModel.ModifyIpamScopeRequest(
            description: nil,
            dryRun: nil,
            ipamScopeId: "value")
...
public extension ModifyIpamScopeResult {
    /**
     Default instance of the ModifyIpamScopeResult structure.
     */
    static let __default: ElasticComputeCloudModel.ModifyIpamScopeResult = {
        let defaultInstance = ElasticComputeCloudModel.ModifyIpamScopeResult(
            ipamScope: nil)
...
public extension ModifyLocalGatewayRouteRequest {
    /**
     Default instance of the ModifyLocalGatewayRouteRequest structure.
     */
    static let __default: ElasticComputeCloudModel.ModifyLocalGatewayRouteRequest = {
        let defaultInstance = ElasticComputeCloudModel.ModifyLocalGatewayRouteRequest(
            destinationCidrBlock: nil,
            destinationPrefixListId: nil,
            dryRun: nil,
            localGatewayRouteTableId: "value",
...
public extension ModifyLocalGatewayRouteResult {
    /**
     Default instance of the ModifyLocalGatewayRouteResult structure.
     */
    static let __default: ElasticComputeCloudModel.ModifyLocalGatewayRouteResult = {
        let defaultInstance = ElasticComputeCloudModel.ModifyLocalGatewayRouteResult(
            route: nil)
...
public extension ModifySecurityGroupRulesRequest {
    /**
     Default instance of the ModifySecurityGroupRulesRequest structure.
     */
    static let __default: ElasticComputeCloudModel.ModifySecurityGroupRulesRequest = {
        let defaultInstance = ElasticComputeCloudModel.ModifySecurityGroupRulesRequest(
            dryRun: nil,
            groupId: "value",
            securityGroupRules: [])
...
public extension ModifySecurityGroupRulesResult {
    /**
     Default instance of the ModifySecurityGroupRulesResult structure.
     */
    static let __default: ElasticComputeCloudModel.ModifySecurityGroupRulesResult = {
        let defaultInstance = ElasticComputeCloudModel.ModifySecurityGroupRulesResult(
            return: nil)
...
public extension ModifySnapshotTierRequest {
    /**
     Default instance of the ModifySnapshotTierRequest structure.
     */
    static let __default: ElasticComputeCloudModel.ModifySnapshotTierRequest = {
        let defaultInstance = ElasticComputeCloudModel.ModifySnapshotTierRequest(
            dryRun: nil,
            snapshotId: "value",
            storageTier: nil)
...
public extension ModifySnapshotTierResult {
    /**
     Default instance of the ModifySnapshotTierResult structure.
     */
    static let __default: ElasticComputeCloudModel.ModifySnapshotTierResult = {
        let defaultInstance = ElasticComputeCloudModel.ModifySnapshotTierResult(
            snapshotId: nil,
            tieringStartTime: nil)
...
public extension ModifyVpcEndpointServicePayerResponsibilityRequest {
    /**
     Default instance of the ModifyVpcEndpointServicePayerResponsibilityRequest structure.
     */
    static let __default: ElasticComputeCloudModel.ModifyVpcEndpointServicePayerResponsibilityRequest = {
        let defaultInstance = ElasticComputeCloudModel.ModifyVpcEndpointServicePayerResponsibilityRequest(
            dryRun: nil,
            payerResponsibility: .__default,
            serviceId: "value")
...
public extension ModifyVpcEndpointServicePayerResponsibilityResult {
    /**
     Default instance of the ModifyVpcEndpointServicePayerResponsibilityResult structure.
     */
    static let __default: ElasticComputeCloudModel.ModifyVpcEndpointServicePayerResponsibilityResult = {
        let defaultInstance = ElasticComputeCloudModel.ModifyVpcEndpointServicePayerResponsibilityResult(
            returnValue: nil)
...
public extension ModifyVpnTunnelOptionsSpecification {
    ...
    static let __default: ElasticComputeCloudModel.ModifyVpnTunnelOptionsSpecification = {
        let defaultInstance = ElasticComputeCloudModel.ModifyVpnTunnelOptionsSpecification(
            ...
            enableTunnelLifecycleControl: nil,
            iKEVersions: nil,
            logOptions: nil,
...
public extension MoveByoipCidrToIpamRequest {
    /**
     Default instance of the MoveByoipCidrToIpamRequest structure.
     */
    static let __default: ElasticComputeCloudModel.MoveByoipCidrToIpamRequest = {
        let defaultInstance = ElasticComputeCloudModel.MoveByoipCidrToIpamRequest(
            cidr: "value",
            dryRun: nil,
            ipamPoolId: "value",
            ipamPoolOwner: "value")
...
public extension MoveByoipCidrToIpamResult {
    /**
     Default instance of the MoveByoipCidrToIpamResult structure.
     */
    static let __default: ElasticComputeCloudModel.MoveByoipCidrToIpamResult = {
        let defaultInstance = ElasticComputeCloudModel.MoveByoipCidrToIpamResult(
            byoipCidr: nil)
...
public extension NetworkInsightsAccessScope {
    /**
     Default instance of the NetworkInsightsAccessScope structure.
     */
    static let __default: ElasticComputeCloudModel.NetworkInsightsAccessScope = {
        let defaultInstance = ElasticComputeCloudModel.NetworkInsightsAccessScope(
            createdDate: nil,
            networkInsightsAccessScopeArn: nil,
            networkInsightsAccessScopeId: nil,
            tags: nil,
            updatedDate: nil)
...
public extension NetworkInsightsAccessScopeAnalysis {
    /**
     Default instance of the NetworkInsightsAccessScopeAnalysis structure.
     */
    static let __default: ElasticComputeCloudModel.NetworkInsightsAccessScopeAnalysis = {
        let defaultInstance = ElasticComputeCloudModel.NetworkInsightsAccessScopeAnalysis(
            analyzedEniCount: nil,
            endDate: nil,
            findingsFound: nil,
            networkInsightsAccessScopeAnalysisArn: nil,
            networkInsightsAccessScopeAnalysisId: nil,
            networkInsightsAccessScopeId: nil,
            startDate: nil,
            status: nil,
...
public extension NetworkInsightsAccessScopeContent {
    /**
     Default instance of the NetworkInsightsAccessScopeContent structure.
     */
    static let __default: ElasticComputeCloudModel.NetworkInsightsAccessScopeContent = {
        let defaultInstance = ElasticComputeCloudModel.NetworkInsightsAccessScopeContent(
            excludePaths: nil,
            matchPaths: nil,
            networkInsightsAccessScopeId: nil)
...
public extension NetworkInsightsAnalysis {
    /**
     Default instance of the NetworkInsightsAnalysis structure.
     */
    static let __default: ElasticComputeCloudModel.NetworkInsightsAnalysis = {
        let defaultInstance = ElasticComputeCloudModel.NetworkInsightsAnalysis(
            ...
            networkInsightsAnalysisArn: nil,
            networkInsightsAnalysisId: nil,
            networkInsightsPathId: nil,
            networkPathFound: nil,
...
public extension NetworkInsightsPath {
    /**
     Default instance of the NetworkInsightsPath structure.
     */
    static let __default: ElasticComputeCloudModel.NetworkInsightsPath = {
...
public extension PacketHeaderStatement {
    /**
     Default instance of the PacketHeaderStatement structure.
     */
    static let __default: ElasticComputeCloudModel.PacketHeaderStatement = {
        let defaultInstance = ElasticComputeCloudModel.PacketHeaderStatement(
            destinationAddresses: nil,
            destinationPorts: nil,
...
public extension PacketHeaderStatementRequest {
    /**
     Default instance of the PacketHeaderStatementRequest structure.
     */
    static let __default: ElasticComputeCloudModel.PacketHeaderStatementRequest = {
        let defaultInstance = ElasticComputeCloudModel.PacketHeaderStatementRequest(
            destinationAddresses: nil,
            destinationPorts: nil,
            destinationPrefixLists: nil,
            protocols: nil,
...
public extension PathComponent {
    /**
     Default instance of the PathComponent structure.
     */
    static let __default: ElasticComputeCloudModel.PathComponent = {
        let defaultInstance = ElasticComputeCloudModel.PathComponent(
            aclRule: nil,
...
public extension PathFilter {
    /**
     Default instance of the PathFilter structure.
     */
    static let __default: ElasticComputeCloudModel.PathFilter = {
        let defaultInstance = ElasticComputeCloudModel.PathFilter(
...
public extension PathRequestFilter {
    /**
     Default instance of the PathRequestFilter structure.
     */
    static let __default: ElasticComputeCloudModel.PathRequestFilter = {
        let defaultInstance = ElasticComputeCloudModel.PathRequestFilter(
            destinationAddress: nil,
            destinationPortRange: nil,
            sourceAddress: nil,
            sourcePortRange: nil)
...
public extension PathStatement {
    /**
     Default instance of the PathStatement structure.
     */
    static let __default: ElasticComputeCloudModel.PathStatement = {
        let defaultInstance = ElasticComputeCloudModel.PathStatement(
            packetHeaderStatement: nil,
            resourceStatement: nil)

        return defaultInstance
    }()
}

public extension PathStatementRequest {
    /**
     Default instance of the PathStatementRequest structure.
     */
    static let __default: ElasticComputeCloudModel.PathStatementRequest = {
        let defaultInstance = ElasticComputeCloudModel.PathStatementRequest(
            packetHeaderStatement: nil,
            resourceStatement: nil)
...
public extension PrivateDnsDetails {
    /**
     Default instance of the PrivateDnsDetails structure.
     */
    static let __default: ElasticComputeCloudModel.PrivateDnsDetails = {
        let defaultInstance = ElasticComputeCloudModel.PrivateDnsDetails(
            privateDnsName: nil)
...
public extension ProvisionIpamPoolCidrRequest {
    /**
     Default instance of the ProvisionIpamPoolCidrRequest structure.
     */
    static let __default: ElasticComputeCloudModel.ProvisionIpamPoolCidrRequest = {
        let defaultInstance = ElasticComputeCloudModel.ProvisionIpamPoolCidrRequest(
            cidr: nil,
            cidrAuthorizationContext: nil,
            clientToken: nil,
            dryRun: nil,
...
public extension ProvisionIpamPoolCidrResult {
    /**
     Default instance of the ProvisionIpamPoolCidrResult structure.
     */
    static let __default: ElasticComputeCloudModel.ProvisionIpamPoolCidrResult = {
        let defaultInstance = ElasticComputeCloudModel.ProvisionIpamPoolCidrResult(
            ipamPoolCidr: nil)
...
public extension ProvisionPublicIpv4PoolCidrRequest {
    /**
     Default instance of the ProvisionPublicIpv4PoolCidrRequest structure.
     */
    static let __default: ElasticComputeCloudModel.ProvisionPublicIpv4PoolCidrRequest = {
        let defaultInstance = ElasticComputeCloudModel.ProvisionPublicIpv4PoolCidrRequest(
            dryRun: nil,
            ipamPoolId: "value",
            netmaskLength: 0,
            poolId: "value")
...
public extension ProvisionPublicIpv4PoolCidrResult {
    /**
     Default instance of the ProvisionPublicIpv4PoolCidrResult structure.
     */
    static let __default: ElasticComputeCloudModel.ProvisionPublicIpv4PoolCidrResult = {
        let defaultInstance = ElasticComputeCloudModel.ProvisionPublicIpv4PoolCidrResult(
            poolAddressRange: nil,
            poolId: nil)
...
public extension ReferencedSecurityGroup {
    /**
     Default instance of the ReferencedSecurityGroup structure.
     */
    static let __default: ElasticComputeCloudModel.ReferencedSecurityGroup = {
        let defaultInstance = ElasticComputeCloudModel.ReferencedSecurityGroup(
            groupId: nil,
            peeringStatus: nil,
            userId: nil,
            vpcId: nil,
...
public extension RegisterInstanceEventNotificationAttributesRequest {
    ...
    static let __default: ElasticComputeCloudModel.RegisterInstanceEventNotificationAttributesRequest = {
        let defaultInstance = ElasticComputeCloudModel.RegisterInstanceEventNotificationAttributesRequest(
            dryRun: nil,
            instanceTagAttribute: RegisterInstanceTagAttributeRequest.__default)
...
public extension RejectTransitGatewayMulticastDomainAssociationsRequest {
    /**
     Default instance of the RejectTransitGatewayMulticastDomainAssociationsRequest structure.
     */
    static let __default: ElasticComputeCloudModel.RejectTransitGatewayMulticastDomainAssociationsRequest = {
        let defaultInstance = ElasticComputeCloudModel.RejectTransitGatewayMulticastDomainAssociationsRequest(
            dryRun: nil,
            subnetIds: nil,
            transitGatewayAttachmentId: nil,
            transitGatewayMulticastDomainId: nil)
...
public extension RejectTransitGatewayMulticastDomainAssociationsResult {
    /**
     Default instance of the RejectTransitGatewayMulticastDomainAssociationsResult structure.
     */
    static let __default: ElasticComputeCloudModel.RejectTransitGatewayMulticastDomainAssociationsResult = {
        let defaultInstance = ElasticComputeCloudModel.RejectTransitGatewayMulticastDomainAssociationsResult(
            associations: nil)
...
public extension ReleaseIpamPoolAllocationRequest {
    /**
     Default instance of the ReleaseIpamPoolAllocationRequest structure.
     */
    static let __default: ElasticComputeCloudModel.ReleaseIpamPoolAllocationRequest = {
        let defaultInstance = ElasticComputeCloudModel.ReleaseIpamPoolAllocationRequest(
            cidr: "value",
            dryRun: nil,
            ipamPoolAllocationId: "value",
            ipamPoolId: "value")
...
public extension ReleaseIpamPoolAllocationResult {
    /**
     Default instance of the ReleaseIpamPoolAllocationResult structure.
     */
    static let __default: ElasticComputeCloudModel.ReleaseIpamPoolAllocationResult = {
        let defaultInstance = ElasticComputeCloudModel.ReleaseIpamPoolAllocationResult(
            success: nil)
...
public extension RemoveIpamOperatingRegion {
    /**
     Default instance of the RemoveIpamOperatingRegion structure.
     */
    static let __default: ElasticComputeCloudModel.RemoveIpamOperatingRegion = {
        let defaultInstance = ElasticComputeCloudModel.RemoveIpamOperatingRegion(
            regionName: nil)
...
public extension ReplaceVpnTunnelRequest {
    /**
     Default instance of the ReplaceVpnTunnelRequest structure.
     */
    static let __default: ElasticComputeCloudModel.ReplaceVpnTunnelRequest = {
        let defaultInstance = ElasticComputeCloudModel.ReplaceVpnTunnelRequest(
            applyPendingMaintenance: nil,
            dryRun: nil,
            vpnConnectionId: "value",
            vpnTunnelOutsideIpAddress: "value")
...
public extension ReplaceVpnTunnelResult {
    /**
     Default instance of the ReplaceVpnTunnelResult structure.
     */
...
public extension RequestFilterPortRange {
    /**
     Default instance of the RequestFilterPortRange structure.
     */
    static let __default: ElasticComputeCloudModel.RequestFilterPortRange = {
        let defaultInstance = ElasticComputeCloudModel.RequestFilterPortRange(
            fromPort: nil,
            toPort: nil)
...
public extension RequestIpamResourceTag {
    /**
     Default instance of the RequestIpamResourceTag structure.
     */
    static let __default: ElasticComputeCloudModel.RequestIpamResourceTag = {
        let defaultInstance = ElasticComputeCloudModel.RequestIpamResourceTag(
            key: nil,
            value: nil)
...
public extension ResourceStatement {
    /**
     Default instance of the ResourceStatement structure.
     */
    static let __default: ElasticComputeCloudModel.ResourceStatement = {
        let defaultInstance = ElasticComputeCloudModel.ResourceStatement(
            resourceTypes: nil,
            resources: nil)
...
public extension ResourceStatementRequest {
    /**
     Default instance of the ResourceStatementRequest structure.
     */
    static let __default: ElasticComputeCloudModel.ResourceStatementRequest = {
        let defaultInstance = ElasticComputeCloudModel.ResourceStatementRequest(
            resourceTypes: nil,
            resources: nil)
...
public extension RestoreImageFromRecycleBinRequest {
    /**
     Default instance of the RestoreImageFromRecycleBinRequest structure.
     */
    static let __default: ElasticComputeCloudModel.RestoreImageFromRecycleBinRequest = {
        let defaultInstance = ElasticComputeCloudModel.RestoreImageFromRecycleBinRequest(
            dryRun: nil,
            imageId: "value")
...
public extension RestoreImageFromRecycleBinResult {
    /**
     Default instance of the RestoreImageFromRecycleBinResult structure.
     */
    static let __default: ElasticComputeCloudModel.RestoreImageFromRecycleBinResult = {
        let defaultInstance = ElasticComputeCloudModel.RestoreImageFromRecycleBinResult(
            return: nil)
...
public extension RestoreSnapshotFromRecycleBinRequest {
    /**
     Default instance of the RestoreSnapshotFromRecycleBinRequest structure.
     */
    static let __default: ElasticComputeCloudModel.RestoreSnapshotFromRecycleBinRequest = {
        let defaultInstance = ElasticComputeCloudModel.RestoreSnapshotFromRecycleBinRequest(
            dryRun: nil,
            snapshotId: "value")
...
public extension RestoreSnapshotFromRecycleBinResult {
    /**
     Default instance of the RestoreSnapshotFromRecycleBinResult structure.
     */
    static let __default: ElasticComputeCloudModel.RestoreSnapshotFromRecycleBinResult = {
        let defaultInstance = ElasticComputeCloudModel.RestoreSnapshotFromRecycleBinResult(
            description: nil,
            encrypted: nil,
            outpostArn: nil,
            ownerId: nil,
...
public extension RestoreSnapshotTierRequest {
    /**
     Default instance of the RestoreSnapshotTierRequest structure.
     */
    static let __default: ElasticComputeCloudModel.RestoreSnapshotTierRequest = {
        let defaultInstance = ElasticComputeCloudModel.RestoreSnapshotTierRequest(
            dryRun: nil,
            permanentRestore: nil,
            snapshotId: "value",
            temporaryRestoreDays: nil)

        return defaultInstance
    }()
}

public extension RestoreSnapshotTierResult {
    /**
     Default instance of the RestoreSnapshotTierResult structure.
     */
    static let __default: ElasticComputeCloudModel.RestoreSnapshotTierResult = {
        let defaultInstance = ElasticComputeCloudModel.RestoreSnapshotTierResult(
            isPermanentRestore: nil,
            restoreDuration: nil,
...
public extension RuleGroupRuleOptionsPair {
    /**
     Default instance of the RuleGroupRuleOptionsPair structure.
     */
    static let __default: ElasticComputeCloudModel.RuleGroupRuleOptionsPair = {
        let defaultInstance = ElasticComputeCloudModel.RuleGroupRuleOptionsPair(
            ruleGroupArn: nil,
            ruleOptions: nil)
...
public extension RuleGroupTypePair {
    /**
     Default instance of the RuleGroupTypePair structure.
     */
    static let __default: ElasticComputeCloudModel.RuleGroupTypePair = {
        let defaultInstance = ElasticComputeCloudModel.RuleGroupTypePair(
            ruleGroupArn: nil,
            ruleGroupType: nil)
...
public extension RuleOption {
    /**
     Default instance of the RuleOption structure.
     */
    static let __default: ElasticComputeCloudModel.RuleOption = {
        let defaultInstance = ElasticComputeCloudModel.RuleOption(
            keyword: nil,
            settings: nil)
...
public extension SecurityGroupForVpc {
    /**
     Default instance of the SecurityGroupForVpc structure.
     */
    static let __default: ElasticComputeCloudModel.SecurityGroupForVpc = {
        let defaultInstance = ElasticComputeCloudModel.SecurityGroupForVpc(
            description: nil,
            groupId: nil,
            groupName: nil,
            ownerId: nil,
...
public extension SecurityGroupRule {
    /**
     Default instance of the SecurityGroupRule structure.
     */
    static let __default: ElasticComputeCloudModel.SecurityGroupRule = {
        let defaultInstance = ElasticComputeCloudModel.SecurityGroupRule(
            cidrIpv4: nil,
            cidrIpv6: nil,
            description: nil,
            fromPort: nil,
...
public extension SecurityGroupRuleDescription {
    /**
     Default instance of the SecurityGroupRuleDescription structure.
     */
    static let __default: ElasticComputeCloudModel.SecurityGroupRuleDescription = {
        let defaultInstance = ElasticComputeCloudModel.SecurityGroupRuleDescription(
            description: nil,
            securityGroupRuleId: nil)
...
public extension SecurityGroupRuleRequest {
    /**
     Default instance of the SecurityGroupRuleRequest structure.
     */
    static let __default: ElasticComputeCloudModel.SecurityGroupRuleRequest = {
        let defaultInstance = ElasticComputeCloudModel.SecurityGroupRuleRequest(
            cidrIpv4: nil,
            cidrIpv6: nil,
            description: nil,
            fromPort: nil,
...
public extension SecurityGroupRuleUpdate {
    /**
     Default instance of the SecurityGroupRuleUpdate structure.
     */
    static let __default: ElasticComputeCloudModel.SecurityGroupRuleUpdate = {
        let defaultInstance = ElasticComputeCloudModel.SecurityGroupRuleUpdate(
            securityGroupRule: nil,
...
public extension SnapshotRecycleBinInfo {
    /**
     Default instance of the SnapshotRecycleBinInfo structure.
     */
    static let __default: ElasticComputeCloudModel.SnapshotRecycleBinInfo = {
        let defaultInstance = ElasticComputeCloudModel.SnapshotRecycleBinInfo(
            description: nil,
            recycleBinEnterTime: nil,
            recycleBinExitTime: nil,
            snapshotId: nil,
...
public extension SnapshotTierStatus {
    /**
     Default instance of the SnapshotTierStatus structure.
     */
    static let __default: ElasticComputeCloudModel.SnapshotTierStatus = {
        let defaultInstance = ElasticComputeCloudModel.SnapshotTierStatus(
            archivalCompleteTime: nil,
            lastTieringOperationStatus: nil,
            lastTieringOperationStatusDetail: nil,
            lastTieringProgress: nil,
            lastTieringStartTime: nil,
            ownerId: nil,
            restoreExpiryTime: nil,
            snapshotId: nil,
            status: nil,
...
public extension SpotCapacityRebalance {
    /**
     Default instance of the SpotCapacityRebalance structure.
     */
...
public extension SpotMaintenanceStrategies {
    /**
     Default instance of the SpotMaintenanceStrategies structure.
     */
    static let __default: ElasticComputeCloudModel.SpotMaintenanceStrategies = {
        let defaultInstance = ElasticComputeCloudModel.SpotMaintenanceStrategies(
            capacityRebalance: nil)
...
public extension StartNetworkInsightsAccessScopeAnalysisRequest {
    /**
     Default instance of the StartNetworkInsightsAccessScopeAnalysisRequest structure.
     */
    static let __default: ElasticComputeCloudModel.StartNetworkInsightsAccessScopeAnalysisRequest = {
        let defaultInstance = ElasticComputeCloudModel.StartNetworkInsightsAccessScopeAnalysisRequest(
            clientToken: "value",
            dryRun: nil,
            networkInsightsAccessScopeId: "value",
            tagSpecifications: nil)
...
public extension StartNetworkInsightsAccessScopeAnalysisResult {
    /**
     Default instance of the StartNetworkInsightsAccessScopeAnalysisResult structure.
     */
    static let __default: ElasticComputeCloudModel.StartNetworkInsightsAccessScopeAnalysisResult = {
        let defaultInstance = ElasticComputeCloudModel.StartNetworkInsightsAccessScopeAnalysisResult(
            networkInsightsAccessScopeAnalysis: nil)

        return defaultInstance
    }()
}

public extension StartNetworkInsightsAnalysisRequest {
    /**
     Default instance of the StartNetworkInsightsAnalysisRequest structure.
     */
...
public extension StartNetworkInsightsAnalysisResult {
    /**
     Default instance of the StartNetworkInsightsAnalysisResult structure.
     */
    static let __default: ElasticComputeCloudModel.StartNetworkInsightsAnalysisResult = {
        let defaultInstance = ElasticComputeCloudModel.StartNetworkInsightsAnalysisResult(
            networkInsightsAnalysis: nil)
...
public extension SubnetCidrReservation {
    /**
     Default instance of the SubnetCidrReservation structure.
     */
    static let __default: ElasticComputeCloudModel.SubnetCidrReservation = {
        let defaultInstance = ElasticComputeCloudModel.SubnetCidrReservation(
            cidr: nil,
            description: nil,
            ownerId: nil,
            reservationType: nil,
            subnetCidrReservationId: nil,
            subnetId: nil,
            tags: nil)
...
public extension SubnetConfiguration {
    /**
     Default instance of the SubnetConfiguration structure.
     */
    static let __default: ElasticComputeCloudModel.SubnetConfiguration = {
...
public extension ThroughResourcesStatement {
    /**
     Default instance of the ThroughResourcesStatement structure.
     */
    static let __default: ElasticComputeCloudModel.ThroughResourcesStatement = {
        let defaultInstance = ElasticComputeCloudModel.ThroughResourcesStatement(
            resourceStatement: nil)
...
public extension ThroughResourcesStatementRequest {
    /**
     Default instance of the ThroughResourcesStatementRequest structure.
     */
    static let __default: ElasticComputeCloudModel.ThroughResourcesStatementRequest = {
        let defaultInstance = ElasticComputeCloudModel.ThroughResourcesStatementRequest(
            resourceStatement: nil)
...
public extension TransitGatewayAttachmentBgpConfiguration {
    /**
     Default instance of the TransitGatewayAttachmentBgpConfiguration structure.
     */
    static let __default: ElasticComputeCloudModel.TransitGatewayAttachmentBgpConfiguration = {
        let defaultInstance = ElasticComputeCloudModel.TransitGatewayAttachmentBgpConfiguration(
            bgpStatus: nil,
            peerAddress: nil,
            peerAsn: nil,
            transitGatewayAddress: nil,
            transitGatewayAsn: nil)
...
public extension TransitGatewayConnect {
    /**
     Default instance of the TransitGatewayConnect structure.
     */
    static let __default: ElasticComputeCloudModel.TransitGatewayConnect = {
        let defaultInstance = ElasticComputeCloudModel.TransitGatewayConnect(
            creationTime: nil,
            options: nil,
            state: nil,
            tags: nil,
            transitGatewayAttachmentId: nil,
            transitGatewayId: nil,
            transportTransitGatewayAttachmentId: nil)

        return defaultInstance
    }()
}

public extension TransitGatewayConnectOptions {
    /**
     Default instance of the TransitGatewayConnectOptions structure.
     */
    static let __default: ElasticComputeCloudModel.TransitGatewayConnectOptions = {
        let defaultInstance = ElasticComputeCloudModel.TransitGatewayConnectOptions(
            protocol: nil)
...
public extension TransitGatewayConnectPeer {
    /**
     Default instance of the TransitGatewayConnectPeer structure.
     */
    static let __default: ElasticComputeCloudModel.TransitGatewayConnectPeer = {
        let defaultInstance = ElasticComputeCloudModel.TransitGatewayConnectPeer(
            connectPeerConfiguration: nil,
            creationTime: nil,
            state: nil,
            tags: nil,
            transitGatewayAttachmentId: nil,
            transitGatewayConnectPeerId: nil)

        return defaultInstance
    }()
}

public extension TransitGatewayConnectPeerConfiguration {
    /**
     Default instance of the TransitGatewayConnectPeerConfiguration structure.
     */
    static let __default: ElasticComputeCloudModel.TransitGatewayConnectPeerConfiguration = {
        let defaultInstance = ElasticComputeCloudModel.TransitGatewayConnectPeerConfiguration(
...
public extension TransitGatewayConnectRequestBgpOptions {
    /**
     Default instance of the TransitGatewayConnectRequestBgpOptions structure.
     */
    static let __default: ElasticComputeCloudModel.TransitGatewayConnectRequestBgpOptions = {
        let defaultInstance = ElasticComputeCloudModel.TransitGatewayConnectRequestBgpOptions(
            peerAsn: nil)
...
public extension TransitGatewayMulticastDomain {
    ...
    static let __default: ElasticComputeCloudModel.TransitGatewayMulticastDomain = {
        let defaultInstance = ElasticComputeCloudModel.TransitGatewayMulticastDomain(
            ...
            tags: nil,
            transitGatewayId: nil,
            transitGatewayMulticastDomainArn: nil,
            transitGatewayMulticastDomainId: nil)
...
public extension TransitGatewayMulticastDomainOptions {
    /**
     Default instance of the TransitGatewayMulticastDomainOptions structure.
     */
    static let __default: ElasticComputeCloudModel.TransitGatewayMulticastDomainOptions = {
        let defaultInstance = ElasticComputeCloudModel.TransitGatewayMulticastDomainOptions(
            autoAcceptSharedAssociations: nil,
            igmpv2Support: nil,
            staticSourcesSupport: nil)
...
public extension TransitGatewayPeeringAttachment {
    ...
    static let __default: ElasticComputeCloudModel.TransitGatewayPeeringAttachment = {
        let defaultInstance = ElasticComputeCloudModel.TransitGatewayPeeringAttachment(
            accepterTgwInfo: nil,
            accepterTransitGatewayAttachmentId: nil,
            creationTime: nil,
            options: nil,
...
public extension TransitGatewayPeeringAttachmentOptions {
    /**
     Default instance of the TransitGatewayPeeringAttachmentOptions structure.
     */
    static let __default: ElasticComputeCloudModel.TransitGatewayPeeringAttachmentOptions = {
        let defaultInstance = ElasticComputeCloudModel.TransitGatewayPeeringAttachmentOptions(
            dynamicRouting: nil)
...
public extension TransitGatewayPolicyRule {
    /**
     Default instance of the TransitGatewayPolicyRule structure.
     */
    static let __default: ElasticComputeCloudModel.TransitGatewayPolicyRule = {
        let defaultInstance = ElasticComputeCloudModel.TransitGatewayPolicyRule(
            destinationCidrBlock: nil,
            destinationPortRange: nil,
            metaData: nil,
            protocol: nil,
...
public extension TransitGatewayPolicyRuleMetaData {
    /**
     Default instance of the TransitGatewayPolicyRuleMetaData structure.
     */
    static let __default: ElasticComputeCloudModel.TransitGatewayPolicyRuleMetaData = {
        let defaultInstance = ElasticComputeCloudModel.TransitGatewayPolicyRuleMetaData(
            metaDataKey: nil,
            metaDataValue: nil)
...
public extension TransitGatewayPolicyTable {
    /**
     Default instance of the TransitGatewayPolicyTable structure.
     */
    static let __default: ElasticComputeCloudModel.TransitGatewayPolicyTable = {
        let defaultInstance = ElasticComputeCloudModel.TransitGatewayPolicyTable(
            creationTime: nil,
            state: nil,
            tags: nil,
            transitGatewayId: nil,
            transitGatewayPolicyTableId: nil)

        return defaultInstance
    }()
}

public extension TransitGatewayPolicyTableAssociation {
    /**
     Default instance of the TransitGatewayPolicyTableAssociation structure.
     */
    static let __default: ElasticComputeCloudModel.TransitGatewayPolicyTableAssociation = {
        let defaultInstance = ElasticComputeCloudModel.TransitGatewayPolicyTableAssociation(
            resourceId: nil,
            resourceType: nil,
            state: nil,
            transitGatewayAttachmentId: nil,
...
public extension TransitGatewayPolicyTableEntry {
    /**
     Default instance of the TransitGatewayPolicyTableEntry structure.
     */
    static let __default: ElasticComputeCloudModel.TransitGatewayPolicyTableEntry = {
        let defaultInstance = ElasticComputeCloudModel.TransitGatewayPolicyTableEntry(
            policyRule: nil,
            policyRuleNumber: nil,
            targetRouteTableId: nil)
...
public extension TransitGatewayRouteTableAnnouncement {
    /**
     Default instance of the TransitGatewayRouteTableAnnouncement structure.
     */
    static let __default: ElasticComputeCloudModel.TransitGatewayRouteTableAnnouncement = {
        let defaultInstance = ElasticComputeCloudModel.TransitGatewayRouteTableAnnouncement(
            announcementDirection: nil,
            coreNetworkId: nil,
            creationTime: nil,
            peerCoreNetworkId: nil,
            peerTransitGatewayId: nil,
            peeringAttachmentId: nil,
            state: nil,
            tags: nil,
            transitGatewayId: nil,
            transitGatewayRouteTableAnnouncementId: nil,
...
public extension TransitGatewayRouteTableRoute {
    /**
     Default instance of the TransitGatewayRouteTableRoute structure.
     */
    static let __default: ElasticComputeCloudModel.TransitGatewayRouteTableRoute = {
        let defaultInstance = ElasticComputeCloudModel.TransitGatewayRouteTableRoute(
            attachmentId: nil,
            destinationCidr: nil,
            prefixListId: nil,
            resourceId: nil,
...
public extension UnassignPrivateNatGatewayAddressRequest {
    /**
     Default instance of the UnassignPrivateNatGatewayAddressRequest structure.
     */
    static let __default: ElasticComputeCloudModel.UnassignPrivateNatGatewayAddressRequest = {
...
public extension UnassignPrivateNatGatewayAddressResult {
    /**
     Default instance of the UnassignPrivateNatGatewayAddressResult structure.
     */
    static let __default: ElasticComputeCloudModel.UnassignPrivateNatGatewayAddressResult = {
        let defaultInstance = ElasticComputeCloudModel.UnassignPrivateNatGatewayAddressResult(
            natGatewayAddresses: nil,
            natGatewayId: nil)
...
public extension VerifiedAccessSseSpecificationRequest {
    /**
     Default instance of the VerifiedAccessSseSpecificationRequest structure.
     */
    static let __default: ElasticComputeCloudModel.VerifiedAccessSseSpecificationRequest = {
        let defaultInstance = ElasticComputeCloudModel.VerifiedAccessSseSpecificationRequest(
            customerManagedKeyEnabled: nil,
            kmsKeyArn: nil)
...
public extension VerifiedAccessSseSpecificationResponse {
    /**
     Default instance of the VerifiedAccessSseSpecificationResponse structure.
     */
    static let __default: ElasticComputeCloudModel.VerifiedAccessSseSpecificationResponse = {
        let defaultInstance = ElasticComputeCloudModel.VerifiedAccessSseSpecificationResponse(
            customerManagedKeyEnabled: nil,
            kmsKeyArn: nil)
...
public extension VpnTunnelLogOptions {
    /**
     Default instance of the VpnTunnelLogOptions structure.
     */
    static let __default: ElasticComputeCloudModel.VpnTunnelLogOptions = {
        let defaultInstance = ElasticComputeCloudModel.VpnTunnelLogOptions(
            cloudWatchLogOptions: nil)

        return defaultInstance
    }()
}

public extension VpnTunnelLogOptionsSpecification {
    /**
     Default instance of the VpnTunnelLogOptionsSpecification structure.
     */
    static let __default: ElasticComputeCloudModel.VpnTunnelLogOptionsSpecification = {
        let defaultInstance = ElasticComputeCloudModel.VpnTunnelLogOptionsSpecification(
            cloudWatchLogOptions: nil)
