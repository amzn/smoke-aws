...
public protocol SimpleQueueClientProtocol {
    ...
    typealias GetQueueUrlAsyncType = (_ input: SimpleQueueModel.GetQueueUrlRequest, _ completion: @escaping (HTTPResult<SimpleQueueModel.GetQueueUrlResultForGetQueueUrl>) -> ()) throws -> ()
    typealias ListDeadLetterSourceQueuesSyncType = (_ input: SimpleQueueModel.ListDeadLetterSourceQueuesRequest) throws -> SimpleQueueModel.ListDeadLetterSourceQueuesResultForListDeadLetterSourceQueues
    typealias ListDeadLetterSourceQueuesAsyncType = (_ input: SimpleQueueModel.ListDeadLetterSourceQueuesRequest, _ completion: @escaping (HTTPResult<SimpleQueueModel.ListDeadLetterSourceQueuesResultForListDeadLetterSourceQueues>) -> ()) throws -> ()
    typealias ListQueueTagsSyncType = (_ input: SimpleQueueModel.ListQueueTagsRequest) throws -> SimpleQueueModel.ListQueueTagsResultForListQueueTags
    typealias ListQueueTagsAsyncType = (_ input: SimpleQueueModel.ListQueueTagsRequest, _ completion: @escaping (HTTPResult<SimpleQueueModel.ListQueueTagsResultForListQueueTags>) -> ()) throws -> ()
    ...
    /**
     ...
     - Throws: overLimit.
     */
    func addPermissionSync(input: SimpleQueueModel.AddPermissionRequest) throws
     ...
     */
    func changeMessageVisibilitySync(input: SimpleQueueModel.ChangeMessageVisibilityRequest) throws
     ...
     */
    func changeMessageVisibilityBatchAsync(input: SimpleQueueModel.ChangeMessageVisibilityBatchRequest, completion: @escaping (HTTPResult<SimpleQueueModel.ChangeMessageVisibilityBatchResultForChangeMessageVisibilityBatch>) -> ()) throws
     ...
     */
    func changeMessageVisibilityBatchSync(input: SimpleQueueModel.ChangeMessageVisibilityBatchRequest) throws -> SimpleQueueModel.ChangeMessageVisibilityBatchResultForChangeMessageVisibilityBatch
     ...
     */
    func createQueueAsync(input: SimpleQueueModel.CreateQueueRequest, completion: @escaping (HTTPResult<SimpleQueueModel.CreateQueueResultForCreateQueue>) -> ()) throws
     ...
     */
    func createQueueSync(input: SimpleQueueModel.CreateQueueRequest) throws -> SimpleQueueModel.CreateQueueResultForCreateQueue
     ...
     */
    func deleteMessageSync(input: SimpleQueueModel.DeleteMessageRequest) throws
    ...
    /**
     ...
     - Parameters:
         ...
         - completion: The DeleteMessageBatchResultForDeleteMessageBatch object or an error will be passed to this 
           ...
           The possible errors are: batchEntryIdsNotDistinct, emptyBatchRequest, invalidBatchEntryId, tooManyEntriesInBatchRequest.
     */
    func deleteMessageBatchAsync(input: SimpleQueueModel.DeleteMessageBatchRequest, completion: @escaping (HTTPResult<SimpleQueueModel.DeleteMessageBatchResultForDeleteMessageBatch>) -> ()) throws
    ...
    /**
     ...
     - Throws: batchEntryIdsNotDistinct, emptyBatchRequest, invalidBatchEntryId, tooManyEntriesInBatchRequest.
     */
    func deleteMessageBatchSync(input: SimpleQueueModel.DeleteMessageBatchRequest) throws -> SimpleQueueModel.DeleteMessageBatchResultForDeleteMessageBatch
    ...
    /**
     ...
     - Parameters:
         - input: The validated DeleteQueueRequest object being passed to this operation.
     */
    func deleteQueueSync(input: SimpleQueueModel.DeleteQueueRequest) throws
     ...
     */
    func getQueueAttributesAsync(input: SimpleQueueModel.GetQueueAttributesRequest, completion: @escaping (HTTPResult<SimpleQueueModel.GetQueueAttributesResultForGetQueueAttributes>) -> ()) throws
     ...
     */
    func getQueueAttributesSync(input: SimpleQueueModel.GetQueueAttributesRequest) throws -> SimpleQueueModel.GetQueueAttributesResultForGetQueueAttributes
     ...
     */
    func getQueueUrlAsync(input: SimpleQueueModel.GetQueueUrlRequest, completion: @escaping (HTTPResult<SimpleQueueModel.GetQueueUrlResultForGetQueueUrl>) -> ()) throws
     ...
     */
    func getQueueUrlSync(input: SimpleQueueModel.GetQueueUrlRequest) throws -> SimpleQueueModel.GetQueueUrlResultForGetQueueUrl
    ...
    /**
     ...
     - Parameters:
         ...
         - completion: The ListDeadLetterSourceQueuesResultForListDeadLetterSourceQueues object or an error will be passed to this 
           ...
           The possible errors are: queueDoesNotExist.
     */
    func listDeadLetterSourceQueuesAsync(input: SimpleQueueModel.ListDeadLetterSourceQueuesRequest, completion: @escaping (HTTPResult<SimpleQueueModel.ListDeadLetterSourceQueuesResultForListDeadLetterSourceQueues>) -> ()) throws
    ...
    /**
     ...
     - Throws: queueDoesNotExist.
     */
    func listDeadLetterSourceQueuesSync(input: SimpleQueueModel.ListDeadLetterSourceQueuesRequest) throws -> SimpleQueueModel.ListDeadLetterSourceQueuesResultForListDeadLetterSourceQueues
    ...
    /**
     ...
     - Parameters:
         ...
         - completion: The ListQueueTagsResultForListQueueTags object or an error will be passed to this 
           ...
           object will be validated before being returned to caller.
     */
    func listQueueTagsAsync(input: SimpleQueueModel.ListQueueTagsRequest, completion: @escaping (HTTPResult<SimpleQueueModel.ListQueueTagsResultForListQueueTags>) -> ()) throws
    ...
    /**
     ...
     - Returns: The ListQueueTagsResultForListQueueTags object to be passed back from the caller of this operation.
         Will be validated before being returned to caller.
     */
    func listQueueTagsSync(input: SimpleQueueModel.ListQueueTagsRequest) throws -> SimpleQueueModel.ListQueueTagsResultForListQueueTags
    ...
    /**
     ...
     - Parameters:
         ...
         - completion: The ListQueuesResultForListQueues object or an error will be passed to this 
           ...
           object will be validated before being returned to caller.
     */
    func listQueuesAsync(input: SimpleQueueModel.ListQueuesRequest, completion: @escaping (HTTPResult<SimpleQueueModel.ListQueuesResultForListQueues>) -> ()) throws
    ...
    /**
     ...
     - Returns: The ListQueuesResultForListQueues object to be passed back from the caller of this operation.
         Will be validated before being returned to caller.
     */
    func listQueuesSync(input: SimpleQueueModel.ListQueuesRequest) throws -> SimpleQueueModel.ListQueuesResultForListQueues
     ...
     */
    func purgeQueueSync(input: SimpleQueueModel.PurgeQueueRequest) throws
    ...
    /**
     ...
     - Parameters:
         ...
         - completion: The ReceiveMessageResultForReceiveMessage object or an error will be passed to this 
           ...
           The possible errors are: overLimit.
     */
    func receiveMessageAsync(input: SimpleQueueModel.ReceiveMessageRequest, completion: @escaping (HTTPResult<SimpleQueueModel.ReceiveMessageResultForReceiveMessage>) -> ()) throws
    ...
    /**
     ...
     - Throws: overLimit.
     */
    func receiveMessageSync(input: SimpleQueueModel.ReceiveMessageRequest) throws -> SimpleQueueModel.ReceiveMessageResultForReceiveMessage
    ...
    /**
     ...
     - Parameters:
         - input: The validated RemovePermissionRequest object being passed to this operation.
     */
    func removePermissionSync(input: SimpleQueueModel.RemovePermissionRequest) throws
     ...
     */
    func sendMessageAsync(input: SimpleQueueModel.SendMessageRequest, completion: @escaping (HTTPResult<SimpleQueueModel.SendMessageResultForSendMessage>) -> ()) throws
     ...
     */
    func sendMessageSync(input: SimpleQueueModel.SendMessageRequest) throws -> SimpleQueueModel.SendMessageResultForSendMessage
     ...
     */
    func sendMessageBatchAsync(input: SimpleQueueModel.SendMessageBatchRequest, completion: @escaping (HTTPResult<SimpleQueueModel.SendMessageBatchResultForSendMessageBatch>) -> ()) throws
     ...
     */
    func sendMessageBatchSync(input: SimpleQueueModel.SendMessageBatchRequest) throws -> SimpleQueueModel.SendMessageBatchResultForSendMessageBatch
    ...
    /**
     ...
     - Throws: invalidAttributeName.
     */
    func setQueueAttributesSync(input: SimpleQueueModel.SetQueueAttributesRequest) throws
    ...
    /**
     ...
     - Parameters:
         - input: The validated TagQueueRequest object being passed to this operation.
     */
    func tagQueueSync(input: SimpleQueueModel.TagQueueRequest) throws
    ...
    /**
     ...
     - Parameters:
         - input: The validated UntagQueueRequest object being passed to this operation.
     */
    func untagQueueSync(input: SimpleQueueModel.UntagQueueRequest) throws
}
