...
/**
 Mock Client for the CodePipeline service that by default always throws from its methods.
 */
public struct ThrowingCodePipelineClientV2: CodePipelineClientProtocolV2 {
#if (os(Linux) && compiler(>=5.5)) || (!os(Linux) && compiler(>=5.5.2)) && canImport(_Concurrency)
    let error: CodePipelineError
     ...
     */
    public init(error: CodePipelineError,
