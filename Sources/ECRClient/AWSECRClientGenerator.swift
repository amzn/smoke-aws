...
/**
 AWS Client Generator for the ECR service.
 */
public struct AWSECRClientGenerator {
    ...
    public func with<NewInvocationReportingType: HTTPClientCoreInvocationReporting>(
            reporting: NewInvocationReportingType) -> AWSECRClient<NewInvocationReportingType> {
        return AWSECRClient<NewInvocationReportingType>(
    ...
    public func with(
            logger: Logging.Logger,
            internalRequestId: String = "none") -> AWSECRClient<StandardHTTPClientCoreInvocationReporting<AWSClientInvocationTraceContext>> {
        let reporting = StandardHTTPClientCoreInvocationReporting(
            logger: logger,
            internalRequestId: internalRequestId,
