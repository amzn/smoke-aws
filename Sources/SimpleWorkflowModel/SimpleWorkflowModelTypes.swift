...
extension SimpleWorkflowModel.ResourceTagKey {
    public func validateAsResourceTagKey() throws {
        if self.count < 1 {
            throw SimpleWorkflowCodingError.validationError(reason: "The provided value to ResourceTagKey violated the minimum length constraint.")
        }

        if self.count > 128 {
            throw SimpleWorkflowCodingError.validationError(reason: "The provided value to ResourceTagKey violated the maximum length constraint.")
        }
    }
}
...
extension SimpleWorkflowModel.ResourceTagValue {
    public func validateAsResourceTagValue() throws {
        ...
        if self.count > 256 {
            throw SimpleWorkflowCodingError.validationError(reason: "The provided value to ResourceTagValue violated the maximum length constraint.")
        }
    }
}
