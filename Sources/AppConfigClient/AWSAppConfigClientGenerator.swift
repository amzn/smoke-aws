...
/**
 AWS Client Generator for the AppConfig service.
 */
public struct AWSAppConfigClientGenerator {
    ...
    public func with<NewInvocationReportingType: HTTPClientCoreInvocationReporting>(
            reporting: NewInvocationReportingType) -> AWSAppConfigClient<NewInvocationReportingType> {
        return AWSAppConfigClient<NewInvocationReportingType>(
    ...
    public func with<NewTraceContextType: InvocationTraceContext>(
            ...
            traceContext: NewTraceContextType) -> AWSAppConfigClient<StandardHTTPClientCoreInvocationReporting<NewTraceContextType>> {
    ...
    public func with(
            logger: Logging.Logger,
            internalRequestId: String = "none") -> AWSAppConfigClient<StandardHTTPClientCoreInvocationReporting<AWSClientInvocationTraceContext>> {
        let reporting = StandardHTTPClientCoreInvocationReporting(
            logger: logger,
            internalRequestId: internalRequestId,
